...
Μετά το fork, δημιουργείστε ένα κλαδί με το ΑΜ σας και μετά (μέσα στον φάκελο `projects`) έναν φάκελο με το ΑΜ σας (μόνο τον αριθμό, χωρίς πρόθεμα, π.χ., 201XXXX) με ένα αρχείο README.md σύμφωνα με τις [αναλυτικές οδηγίες](https://courses-ionio.github.io/help/guide/)
