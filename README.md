...
Δούλεψα πάνω στο YouTube Video Player. Η άσκηση ζητάει να δημιουργηθούν δύο κουμπιά ένα για αναπαραγωγή (Play) και ένα για παύση (Pause) του μουσικού βίντεο. Το αποτέλεσμα παρουσιάζεται στο παρακάτω link:
