...
Αν μπορώ να αναφερθώ στους προσωπικούς στόχους και ανάγκες που προέκυψαν στο πλαίσιο αυτού του μαθήματος, θα έλεγα μια μεγαλύτερη γνώση στο αντικείμενο της αλληλεπίδρασης ανθρώπου - υπολογιστή. Πως αυτή ορίζεται, αλλά και πως επιτυγχάνεται.  
