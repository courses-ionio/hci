...
| --- | --- |
| 1 |[Εισαγωγή](#Εισαγωγή) |
| 2 |[Άσκηση γραμμής εντολών 1](#Άσκηση-γραμμής-εντολών-1-και-εγκατάσταση-Arch-Linux) |
...
# Άσκηση γραμμής εντολών 1 και εγκατάσταση  Arch Linux
...
1) Πραγματοποιήθηκε επιτυχής κανονική εγκατάσταση του λειτουργικού συστήματος Arch Linux σε ξεχωριστό σύστημα (Laptop) μέσω Bootable USB flashdrive και με τα βήματα όπως προτίνεται από https://wiki.archlinux.org/title/installation_guide.  
