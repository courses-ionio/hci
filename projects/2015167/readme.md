...
| Εβδομάδα | Παραδοτέο |
| --- | --- |
| 1 | [Εισαγωγή και περιγραφή των στόχων μου για το μάθημα](#εισαγωγή) και [σύνοψη](#σύνοψη) |
...
| 12 | [Συμπεράσματα](#συμπεράσματα) |

<h2>Εισαγωγή</h2>
Έγινε fork του <a href="https://github.com/panosath/site" title="link to my fork of the site repo">αποθετηρίου του βιβλίου</a> και του <a href="https://github.com/panosath/hci/tree/2015167/projects/2015167" title="link to my fork of the /hci repo">αποθετηρίου του μαθήματος</a> σε προσωπικό αποθετήριο καθώς δημιουργήθηκε branch με όνομα τον αριθμό μητρώου μου, στο οποίο θα αναρτώνται οι εργασίες. Για τις ανάγκες του μαθήματος, εγκατέστησα το λειτουργικό σύστημα Ubuntu 20.04 LTS σε virtual machine. Έχοντας προσωπική εμπειρία με την εγκατάσταση και βασική χρήση του συγκεκριμένου OS, δεν μου εμφανίστηκαν σοβαρά προβλήματα κατα τη διεξαγωγή των παραδοτέων, παρόλα αυτά επέλυσα οσα εμφανίστηκαν μέσω μελέτης στο διαδίκτυο. Χρησιμοποίησα επίσης και το git for windows και υποσύστημα Linux των Windows 10 για την διαχείριση των git submodule. Οι προσδοκίες μου από αυτό το μάθημα είναι η εξοικείωση με το περιβάλλον του github, καθώς και με το περιβάλλον UNIX και η καλύτερη επαφή με κάποιες τεχνικές προγραμματισμού μέσω ασκήσεων του μαθήματος, κυρίως με γλώσσες που σχετίζονται με δημιουργία και σχεδιασμό ιστοσελίδων όπως είναι η HTML, η CSS και άλλες εκδοχές τις καθώς και η JavaScript.
<hr>

<h2>Σύνοψη</h2>
Για την επλήρωση των παραδοτέων, επέλεξα συγκεκριμένες ασκήσεις προγραμματισμού και γραμμών εντολών. Για τις ασκήσεις προγραμματισμού επέλεξα τις: Zoom Hover Effect, Form Validation, Menu Scroll και Mouse Eraser. Αυτές οι ασκήσεις παραδόθηκαν όλες εντός των ορισμένων προθεσμιών τους. Δεν χρειάστηκε να κάνω περαιτέρω αναζητήσεις για να ολοκληρώσω τα ζητούμενα των ασκήσεων εκτός μονο μιας, της Menu Scroll, όπου χρειάστηκε να ανατρέξω σε μια ιστοσελίδα για να βρώ βοήθεια για κάποιες γραμμές κώδικα. Ο τρόπος με τον οποίο διαχειρίστηκα τις ασκήσεις ήταν κυρίως με πειραματισμό, μελετώντας τον υπάρχων κώδικα και γράφοντας τον δικό μου ανάλογα. Για τις ασκήσεις γραμμών εντολών επέλεξα τις εξής: Taskwarrior, vimrc, youtube dl και mpv player και emacs editor. Αυτές οι ασκήσεις παραδόθηκαν όλες εντός των ορισμένων προθεσμιών τους, πλήν της τελευταίας η οποία παραδόθηκε μια εβδομάδα αργότερα λόγω τεχνικών προβλημάτων που αντιμετώπιζα με το virtual machine μου που χρησιμοποιώ για να προσομοιώσω σύστημα Linux. Για την εκπλήρωση αυτών των ασκήσεων έκανα αναζητήσεις στο διαδίκτυο για να κατανοήσω την χρησιμότητά των προγραμμάτων και το πως λειτουργούν. Υπάρχουν σχετικές αναφορές στις πηγές που συμβουλεύθηκα στο τέλος του κάθε παραδοτέου. Για την δημιουργία των εικόνων gif χρησιμοποίησα το πρόγραμμα OBS για την καταγραφή της οθόνης μου και την ιστοσελίδα <a href="https://ezgif.com/" title="ezgif site">ezgif.com</a> για την μετατροπή των καταγραφών μου σε εικόνες gif. Όλες οι εικόνες που εμφανίζονται εδώ, είναι αποθηκευμένες σε προσωπικό μου <a href="https://github.com/panosath/hci-pic-repo" title="link to my pic repo">αποθετήριο</a>.
<hr><br>

<h2>Παρουσίαση των ασκήσεων</h2><br>
...
Για το πρώτο μέρος του συμμετοχικού περιεχομένου προστέθηκαν δυο entries και οι αντίστοιχες εικόνες τους: <a href="https://panosath-pibook.netlify.app//gallery/limewire/" title="link to book entry">LimeWire</a> και <a href="https://panosath-pibook.netlify.app//gallery/utorrent/" title="link to book entry">uTorrent</a>. Κάνοντας κλικ επάνω στα ονόματά τους, ανοίγει η αντίστοιχη σελίδα στο site του βιβλίου. Η επιλογή των συγκεκριμένων προγραμμάτων έγινε λόγω της επίδρασης που είχαν τέτοιου υπηρεσίες στον κόσμο του διαδικτύου και εξ' αιτίας της απλής διεπαφής μεταξύ των προγραμμάτων και των χρηστών. Εδώ βρίσκονται τα link στο αποθετήριο του βιβλίου: του LimeWire: https://github.com/panosath/_gallery/blob/master/limewire.md και του uTorrent: https://github.com/panosath/_gallery/blob/master/utorrent.md. Πρόσθεσα επίσης και στην ήδη υπάρχουσα διαφάνεια <a href="https://panosath-pibook.netlify.app//slides/definition/" title="link to the slide">"Ορισμός"</a> τα δυο αυτά entries. Αρχικά κατα την δημιουργία συνάντησα προβλήματα με το git και τα submodules καθώς δεν μπορούσα να καταφέρω συγχρονισμό των submodules αλλά έπειτα απο πειραματισμό στο git και αναζήτηση στο διαδίκτυο και κυρίως στο stackoverflow.com κατάφερα το επιθυμιτό αποτέλεσμα.<br>
<br>Πηγές: <br>
<a href="https://en.wikipedia.org/wiki/LimeWire" title="link to source page">LimeWire - Wikipedia</a><br>
<a href="https://en.wikipedia.org/wiki/%CE%9CTorrent" title="link to source page">uTorrent - Wikipedia</a><br>
<a href="https://stackoverflow.com/questions/8191299/update-a-submodule-to-the-latest-commit" title="link to source page">update a submodule to the latest commit | stackoverflow</a><br>
<a href="https://stackoverflow.com/questions/34153029/why-does-git-submodule-show-wrong-branch" title="link to source page">fix a submodule that shows to the wrong branch | stackoverflow</a><br>
<hr>
...
Για το δεύτερο μέρος του συμμετοχικού περιεχομένου προστέθηκε η <a href="https://panosath-pibook.netlify.app//case-study/peer-to-peer/" title="link to netlify pibook page">μελέτη περίπτωσης των peer-to-peer file sharing υπηρεσιών</a> και η <a href="https://panosath-pibook.netlify.app//biography/jeff-bezos/" title="link to netlify pibook page">βιογραφία του Jeff Bezos</a>. Κάνοντας κλικ επάνω στα ονόματά τους, ανοίγει η αντίστοιχη σελίδα στο site του βιβλίου. Για αυτό το παραδοτέο, επέλεξα τις peer-to-peer υπηρεσιών για τον απλοϊκό σχεδιασμό των προγραμμάτων τους και για την αμεσότητά τους στην διεπαφή με τον χρήστη. Η επιλογή του Jeff Bezos είχε κίνητρο τον θαυμασμό, την προσπάθεια και τη επιτυχία του έργου του, καθώς η Amazon με τον καιρό, άλλαξε τα δεδομένα όσον αφορά αγορές μέσω του διαδικτύου σε παγκόσμιο επίπεδο. Εδώ βρίσκονται τα link στο αποθετήριο του βιβλίου: της μελέτης περίπτωσης: https://github.com/panosath/site/blob/master/_case-study/peer-to-peer.md και της βιογραφίας: https://github.com/panosath/site/blob/master/_biography/jeff-bezos.md, https://github.com/panosath/site/blob/master/_biography/bio-bezos.md. Πρόσθεσα επίσης και δυο εικόνες για χρήση στην βιογραφία του Jeff Bezos, ενώ χρησιμοποίησα εικόνες που είχα προσθέσει στο Α μέρος του συμμετοχικού περιεχομένου αλλά και ήδη υπάρχουσες για την μελέτη περίπτωσης.<br>
<br>Πηγές: <br>
<a href="https://en.wikipedia.org/wiki/Jeff_Bezos" title="link to source page">Jeff Bezos - Wikipedia</a><br>
<a href="https://en.wikipedia.org/wiki/Peer-to-peer_file_sharing" title="link to source page">Peer-to-peer file sharing - Wikipedia</a><br>
<a href="https://en.wikipedia.org/wiki/Timeline_of_file_sharing" title="link to source page">Timeline of file sharing - Wikipedia</a><br>
<hr>

<h2>Συμπεράσματα</h2>
Κοιτόντας πίσω στον χρόνο και πιο συγκεκριμένα στις αρχές του εξαμήνου, η διαφορά στις γνώσεις μου για τα αντικείμενα ειναι προφανής. Δουλεύοντας κάθε εβδομάδα σε ενα διαφορετικό παραδοτέο, με βοήθησε να εξοικειωθώ με ορισμένες τεχνικές προγραμματισμού, κυρίως μέσω των ασκήσεων προγραμματισμού. Πιο συγκεκριμένα, με βοήθησαν να εξοικειωθώ με γλώσσες όπως η HTML και CSS αλλά και JavaScript και να κατανοήσω μετά απο πειραματισμό με μικρές αλλαγές σε υπάρχων κώδικα, τις λειτουργίες που μπορώ να δημιουργήσω και να επεξεργαστώ. Οι ασκήσεις γραμμής εντολών μου έδωσαν να καταλάβω πόσο απαιτητική μπορεί να γίνει η εργασία αποκλειστικά μέσω terminal, καθώς σε αυτές αντιμετώπισα τις περισσότερες προκλήσεις. Η παρακολούθηση των εργαστηρίων του μαθήματος αποδείχθηκε ιδιαίτερα σημαντική διότι μου λήθηκαν αρκετές απορίες, αρκετές από τις οποίες μοιραζόμουν με συναδέλφους μου. Οι δυσκολίες που συνάντησα με τα submodules μου εδείξε πόσο προσεκτικά πρέπει να ακολουθώ τα βήματα για διαδικασίες του git. Η αδυναμία μου να καταφέρω να κάνω τα submodules να λειτουργήσουν σωστά εγκαίρως μου δημιούργησε πρόβλημα με την παράδοση και των δυο μελών του συμμετοχικού περιεχομένου, τα οποία παρέδωσα και τα δυο με λίγες μέρες διαφορά απο την διωρία τους. Νιώθω ικανοποιημένος από τις γνώσεις που έλαβα καθ'όλην τη διάρκεια του μαθήματος, και ευελπιστώ να φανούν πρακτικές στο μέλλον μου, ιδιαιτέρως στον επαγγελματικό τομέα.
