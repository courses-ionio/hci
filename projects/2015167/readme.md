...
<h2>Συμπεράσματα</h2>
Κοιτόντας πίσω στον χρόνο και πιο συγκεκριμένα στις αρχές του εξαμήνου, πριν ξεκινήσω να ασχολούμαι με το μάθημα, η διαφορά στις γνώσεις μου για τα αντικείμενα μου ειναι προφανής. Δουλεύοντας κάθε εβδομάδα σε ενα διαφορετικό παραδοτέο, με βοήθησε να εξοικειωθώ με ορισμένες τεχνικές προγραμματισμού, κυρίως μέσω των ασκήσεων προγραμματισμού. Πιο συγκεκριμένα, με βοήθησαν να εξοικειωθώ με γλώσσες όπως η HTML και CSS αλλά και JavaScript. Οι ασκήσεις γραμμής εντολών μου έδωσαν να καταλάβω πόσο απαιτητική μπορεί να γίνει η εργασία μέσω terminal αποκλειστικά, καθώς σε αυτές αντιμετώπισα τις περισσότερες προκλήσεις. Η παρακολούθηση των εργαστηρίων του μαθήματος αποδείχθηκε ιδιαίτερα σημαντική διότι μου λήθηκαν αρκετές απορίες, αρκετές από τις οποίες μοιραζόμουν με συναδέλφους μου. Οι δυσκολίες που συνάντησα με τα submodules μου εδείξε πόσο προσεκτικά πρέπει να ακολουθώ τα βήματα για διαδικασίες του git. Η αδυναμία μου να καταφέρω να κάνω τα submodules να λειτουργήσουν σωστά εγκαίρως μου δημιούργησε πρόβλημα με την παράδοση και των δυο μελών του συμμετοχικού περιεχομένου, τα οποία παρέδωσα και τα δυο με λίγες μέρες διαφορά απο την διωρία τους. Είμαι ικανοποιημένος από τις γνώσεις που έλαβα καθ'όλην τη διάρκεια του μαθήματος, και ευελπιστώ να φανούν πρακτικές στο μέλλον μου, ιδιαιτέρως στον επαγγελματικό τομέα.
