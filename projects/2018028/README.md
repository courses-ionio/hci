...
<br>
Βιβλιογραφία:https://www.howtogeek.com/103574/how-to-browse-from-the-linux-terminal-with-w3m/<br>
http://manpages.ubuntu.com/manpages/xenial/man1/w3m.1.html<br>
http://linuxcommand.org/lc3_wss0010.php<br>
...
Βιβλιογραφία: https://www.linuxuprising.com/2018/07/display-weather-forecast-in-your.html<br>
[![asciicast](https://asciinema.org/a/UCKjAuqRmrhrc7Ug1oAto1P6B.svg)](https://asciinema.org/a/UCKjAuqRmrhrc7Ug1oAto1P6B)
<br>


## 6ο Παραδοτέο
Αυτή η εβδομάδα ήταν αρκετά διαφορετική απο τις προηγούμενες. Αυτήν την φορά έπρεπε να κάνουμε κάτι δικό μας ουσιαστικά, το layout μόνο έμεινε το ίδιο. Το θέμα που επέλεξα για την εργασία του συμμετοχικού περιεχομένου ήταν τα βιντεοπαιχνίδια και ειδικότερα τα κλασσικά βιντεοπαιχνίδια. Έτσι επέλεξα τον πατέρα των βιντεοπαιχνιδιών και προσωπικό μου είδωλλο [Nolan Bushnell](https://github.com/Alkissourvinos/images/blob/master/Nolan-Bushnell.jpg), δημιουργό του [ComputerSpace](https://github.com/Alkissourvinos/images/blob/fecb99a5623ab42aa93a71564a6078627f600f47/computer-space.jpg) και συνιδριτη της εταιρία ανάπτυξης παιχνιδιών Attari. Με προτεργάτη τον Bushnell η βιομηχανία παιχνιδιών ξεκίνησε να κάνει σιγά σιγά τα πρώτα τις βήματα και με τον καιρό να παρατάει τα μηχανήματα Arcade και να φέρνει τα παιχνίδια στα σπίτια των ανθρώπων.

Η 1η [εικόνα](https://hci-p2018028.netlify.app/gallery/nolan-bushnell/) με την λεζάντα της<br> 
Βιβλιογραφία:<br> 
https://en.wikipedia.org/wiki/Nolan_Bushnell<br>
http://nolanbushnell.com/<br>
https://www.thefamouspeople.com/profiles/nolan-bushnell-6310.php<br>
Η 2η [εικόνα](https://hci-p2018028.netlify.app//gallery/computer-space/) με την λεζάντα της<br>
Βιβλιογραφία:<br>
https://en.wikipedia.org/wiki/Computer_Space<br>
https://www.technologizer.com/2011/12/11/computer-space-and-the-dawn-of-the-arcade-video-game/<br><br>
[Slides](https://hci-p2018028.netlify.app/slides/videogamedev/)<br>
[Timeline](https://hci-p2018028.netlify.app/timeline/videogamedev/)<br>
...
Βιβλιογραφία:https://www.youtube.com/watch?v=7ybg3vjLQJM<br>
...
<br>
[Μελέτη περίπτωσης](https://hci-p2018028.netlify.app/case-study/scratch/)<br>
...
[Βιογραφία](https://hci-p2018028.netlify.app/biography/nolan-bushnell/)<br>
...
Σε αυτό το μάθημα, όπως υπογράμμισα και στην εισαγωγή μου, περίμενα να μάθω για τεχνικά κομμάτια, όπως το Github, την γλώσσα Markdown, λειτουργικά με γραμμή εντολών αλλά και να εξοικειωθώ με τις γλώσσες JavaScript, CSS & HTML. Ωστόσο εκτός του ότι εκπλήρωσα τους στόχους που είχα βάλει στην αρχή του εξαμήνου, φτάνοντας στο τέλος του μπορώ πλέον να πω ότι έμαθα ακόμα περισσότερα πράγματα. Αρχικά έμαθα για την ιστορία των υπολογιστών και πως άνθρωποι σαν τον Larry Tesler μέσω του Xerox Alto έφτιαξαν προγράμματα σαν το Alto Gypsy, ένα πρόγραμμα που μοιάζει απίστευτα πολύ με σημερινά αντίστοιχα προγράμματα όπως το Microsft Word. Ποιο είναι το όραμα του Seymour Papert και του Alan Kay. Ποιος κατάφερε να υλοποιήση για πρώτη φορά μια οικονική πραγματικότητα σε υπολογιστή. Όλα αυτά και πολλά ακόμα μοιάζουν σαν να είναι απλές εγκυκλοπαιδικές γνώσεις, όμως πιστεύω ότι ο στόχος του μαθήματος δεν ήταν μόνο αυτός. Πιστεύω ότι ο στόχος του μαθήματος ήταν να μας "περάσει" την ιδέα ότι οι υπολογιστές μπορούν να είναι πάρα πολλά πραγματα και εμείς σαν προγραμματιστές δεν θα έπρεπε να θέλουμε να συνεχίσουμε τον τρόπο με τον οποίο τους χρησιμοποιούμε, όπως είπε και ο Kay σαν ένα κομμάτι χαρτί. Για μένα το μάθημα μου μετέφερε την ιδέα ότι πολλά μπορούν να αλλάξουν στον υπολογιστή και ότι με πολλους τρόπους μπορούμε να τον εξελίξουμε και τέλος ότι δεν πρέπει να επαναπαυώμαστε σε αυτά που έχουμε σήμερα και να προσπαθούσε σύνεχεια να εξελίξουμε ακόμα και κάτι τόσο απλό όπως ένα πληκτρολόγιο. Εάν αυτός ήταν ο στόχος του μαθήματος τότε πιστεύω ότι τον πέτυχε!
