...
Στο συγκεκριμένο παραδοτέο συνέχισα με ασκήσεις warmup για μεγαλύτερη εξοικείωση με την γραμμή εντολών και το terminal.
