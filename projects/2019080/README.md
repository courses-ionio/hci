...
Για το παραδοτέο 6ο, καλούμαστε να δημιουργήσουμε το ηλεκτρονικό βιβλίο σε μορφή PDF με μορφή της επιλογής μας, και να προσθέσουμε τον/την δικό μας σχολιασμό/εισαγωγή σε κάποιο/α κεφάλαια του βιβλίου που βρίκαμε ενδιαφέρον. Το παραδοτέο αυτό ειχε γίνει σαν μια πρώτη προσπάθεια μέσα στην προθεσμία για την ενδιάμεση παρουσίαση αλλά επειδή έγιναν κάποιες αλλαγές που χρειαζόντουσαν, διέγραψα το repo και ξεκίνησα ξανά. Θα παρακαλύσα να μην μετρήσει σαν εκπρόθεμο.
