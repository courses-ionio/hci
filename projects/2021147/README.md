...
| 2 | Άσκηση γραμμής εντολών (linux install) | [ΠΑΡΑΔΟΤΕΟ 2](https://github.com/courses-ionio/help/discussions/1128), Απάντηση στις ερωτήσεις του Edpuzzle 2ης εβδομάδας, Linux install |Ολοκλήρωση ζητούμενων! (100%)|
| 3 | Συμμετοχικό περιεχόμενο A1 |[ΠΑΡΑΔΟΤΕΟ 3](https://github.com/courses-ionio/help/discussions/1224), Απάντηση στις ερωτήσεις του Edpuzzle 3ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Α1 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12)|Ολοκλήρωση ζητούμενων! (100%)|
| 4 | Άσκηση γραμμής εντολών (warm up cli) |[ΠΑΡΑΔΟΤΕΟ 4](https://github.com/courses-ionio/help/discussions/1351), Απάντηση στις ερωτήσεις του Edpuzzle 4ης εβδομάδας, πραγματοποίηση μερικών warm-ups |Ολοκλήρωση ζητούμενων! (100%)|
| 5 | Συμμετοχικό περιεχόμενο A2 |[ΠΑΡΑΔΟΤΕΟ 5](https://github.com/courses-ionio/help/discussions/1484), Απάντηση στις ερωτήσεις του Edpuzzle 5ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Α2 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12) |Ολοκλήρωση ζητούμενων! (100%)|
| 6 | Κατασκευή του βιβλίου Α |[ΠΑΡΑΔΟΤΕΟ 6](https://github.com/courses-ionio/help/discussions/1583), Απάντηση στις ερωτήσεις του Edpuzzle 5ης εβδομάδας, ολοκλήρωση κατασκευής του βιβλίου Α |Ολοκλήρωση ζητούμενων! (100%)|
| 7 | Συμμετοχικό περιεχόμενο B1 |[ΠΑΡΑΔΟΤΕΟ 7](https://github.com/courses-ionio/help/discussions/1700), Απάντηση στις ερωτήσεις του Edpuzzle 7ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Β1 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12) |Ολοκλήρωση ζητούμενων! (100%)|
| 8 | Άσκηση γραμμής εντολών |[ΠΑΡΑΔΟΤΕΟ 8](https://github.com/courses-ionio/help/discussions/1764), Απάντηση στις ερωτήσεις του Edpuzzle 8ης εβδομάδας, υλοποίηση Άσκησης γραμμής εντολών |Ολοκλήρωση ζητούμενων! (100%)|
| 9 | Συμμετοχικό περιεχόμενο B2 |[ΠΑΡΑΔΟΤΕΟ 9](https://github.com/courses-ionio/help/discussions/1700), Απάντηση στις ερωτήσεις του Edpuzzle 9ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Β2 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12) |Ολοκλήρωση ζητούμενων! (100%)|
| 10 | Άσκηση γραμμής εντολών |[ΠΑΡΑΔΟΤΕΟ 10](https://github.com/courses-ionio/help/discussions/1922), Απάντηση στις ερωτήσεις του Edpuzzle 10ης εβδομάδας, υλοποίηση Άσκησης γραμμής εντολών |Ολοκλήρωση ζητούμενων!|
| 11 | Κατασκευή του βιβλίου Β |[ΠΑΡΑΔΟΤΕΟ 11](https://github.com/courses-ionio/help/discussions/1949), Απάντηση στις ερωτήσεις του Edpuzzle 11ης εβδομάδας, ολοκλήρωση κατασκευής του βιβλίου B|Ολοκλήρωση ζητούμενων!(100%)|
| 12 | Τελική αναφορά* |[ΠΑΡΑΔΟΤΕΟ 12](https://github.com/courses-ionio/help/discussions/2056) |Ολοκλήρωση ζητούμενων! (100%) |
### Παραδοτέο 1ο:
## ΕΙΣΑΓΩΓΗ: 
