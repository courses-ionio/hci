...
=> Βαθμός Αυτοαξιολόγησης: 8/10. Η εισαγωγή χρειάστηκε αρκετές επιπλέον εβδομάδες για να ολοκληρωθεί και ακόμη και στην τελική της μορφή θεωρώ ότι δεν είναι απόλυτα ολοκληρωμένη.

=> Βαθμός Αυτοαξιολόγησης: 10/10. Η εγκατάσταση του Arch Linux ολοκληρώθηκε επιτυχώς και εντός του χρονικού περιθωρίου.

=> Βαθμός Αυτοαξιολόγησης: 8/10. Το παραδοτέο δεν ολοκληρώθηκε εμπρόθεσμα αλλά είχε γίνει σημαντική προσπάθεια πρώτου τελειώσει η προθεσμία. Υπήρξαν επίσης ριζικές αλλαγές έπειτα από συζήτηση στην τάξη

=> Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο ολοκληρώθηκε εντός του χρονικού περιθωρίου αλλά θα μπορούσα να εξασκηθώ περισσότερο εκτελώντας επιπλέον warm-ups.

=>Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο είχε ολοκληρωθεί εμπρόθεσμα άλλα υπήρξαν ριζικές αλλαγές έπειτα από συζήτηση στην τάξη.

=> Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο είχε ολοκληρωθεί εμπρόθεσμα άλλα υπήρξαν αλλαγές.

=> Βαθμός Αυτοαξιολόγησης: 8/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα άλλα υπήρξαν ριζικές αλλαγές έπειτα από συζήτηση στην τάξη.

=> Βαθμός Αυτοαξιολόγησης: 10/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα και με επιτυχία!

=> Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα.

=> Βαθμός Αυτοαξιολόγησης: 3/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα άλλα λόγω δικιάς μου παρεξήγησης δεν έχουν πραγματοποιηθεί όλα τα απαιτούμενα ζητούμενα.

=> Βαθμός Αυτοαξιολόγησης: 8/10. Το παραδοτέο ολοκληρώθηκε εκτός προθεσμίας λόγω τεχνικών δυσκολιών.
