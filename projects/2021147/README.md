...
# Βασικές Πληροφορίες:
  ...
  - [Netlify Site](https://panmour.netlify.app/)
  - [Ομάδα Netlify Site](https://OMADA12.netlify.app/)

# Αναφορά:
| Εβδομάδα | [Όλα τα παραδοτέα βρίσκονται στην ίδια σελίδα της τελικής αναφοράς](https://courses-ionio.github.io/help/deliverables/) με τα προσωπικά στοιχεία σας (Όνομα, ΑΜ, github profile) και μαζί με αυτόν εδώ τον πίνακα περιεχομένων | Σύνδεσμος στην [εβδομαδιαία παρουσίαση προόδου στις συζητήσεις](https://github.com/courses-ionio/help/discussions/categories/show-and-tell) | Αυτοαξιολόγηση σύμφωνα με τα κριτήρια της αντίστοιχης άσκησης |
| --- | --- | --- | --- |
| 1 |  [Δημιουργία ομάδας](https://github.com/courses-ionio/hci/discussions/1794) + [Φορκ και δημιουργία σελίδας τελικής αναφοράς](https://courses-ionio.github.io/help/guide/), [προσθήκη πίνακα περιεχομένων](https://raw.githubusercontent.com/courses-ionio/hci/master/README.md), [συγγραφή της εισαγωγής](https://courses-ionio.github.io/help/intro/), αποστολή της εισαγωγής [για σχολιασμό στην συζήτηση](https://github.com/courses-ionio/help/discussions/categories/show-and-tell) και καταγραφή του συνδέσμου συζήτησης δίπλα --> |[ΠΑΡΑΔΟΤΕΟ 1](https://github.com/courses-ionio/help/discussions/893), [Η ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12), Απάντηση στις ερωτήσεις του Edpuzzle 1ης εβδομάδας |Ολοκλήρωση ζητούμενων! (100%)|
| 2 | [Άσκηση γραμμής εντολών (linux install)](https://github.com/courses-ionio/hci/discussions/1814) | [ΠΑΡΑΔΟΤΕΟ 2](https://github.com/courses-ionio/help/discussions/1128), Απάντηση στις ερωτήσεις του Edpuzzle 2ης εβδομάδας, Linux install |Ολοκλήρωση ζητούμενων! (100%)|
| 3 | [Συμμετοχικό περιεχόμενο A1](https://github.com/courses-ionio/hci/discussions/1824)|[ΠΑΡΑΔΟΤΕΟ 3](https://github.com/courses-ionio/help/discussions/1224), Απάντηση στις ερωτήσεις του Edpuzzle 3ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Α1 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12)|Ολοκλήρωση ζητούμενων! (100%)|
| 4 | [Άσκηση γραμμής εντολών (warm up cli)](https://github.com/courses-ionio/hci/discussions/1825) |[ΠΑΡΑΔΟΤΕΟ 4](https://github.com/courses-ionio/help/discussions/1351), Απάντηση στις ερωτήσεις του Edpuzzle 4ης εβδομάδας, πραγματοποίηση μερικών warm-ups |Ολοκλήρωση ζητούμενων! (100%)|
| 5 | [Συμμετοχικό περιεχόμενο A2](https://github.com/courses-ionio/hci/discussions/1829) |[ΠΑΡΑΔΟΤΕΟ 5](https://github.com/courses-ionio/help/discussions/1484), Απάντηση στις ερωτήσεις του Edpuzzle 5ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Α2 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12) |Ολοκλήρωση ζητούμενων! (100%)|
| 6 | [Κατασκευή του βιβλίου Α](https://github.com/courses-ionio/hci/discussions/1832) |[ΠΑΡΑΔΟΤΕΟ 6](https://github.com/courses-ionio/help/discussions/1583), Απάντηση στις ερωτήσεις του Edpuzzle 5ης εβδομάδας, ολοκλήρωση κατασκευής του βιβλίου Α |Ολοκλήρωση ζητούμενων! (100%)|
| 7 | [Συμμετοχικό περιεχόμενο B1](https://github.com/courses-ionio/hci/discussions/1833) |[ΠΑΡΑΔΟΤΕΟ 7](https://github.com/courses-ionio/help/discussions/1700), Απάντηση στις ερωτήσεις του Edpuzzle 7ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Β1 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12) |Ολοκλήρωση ζητούμενων! (100%)|
| 8 | [Άσκηση γραμμής εντολών](https://github.com/courses-ionio/hci/discussions/1837) |[ΠΑΡΑΔΟΤΕΟ 8](https://github.com/courses-ionio/help/discussions/1764), Απάντηση στις ερωτήσεις του Edpuzzle 8ης εβδομάδας, υλοποίηση Άσκησης γραμμής εντολών |Ολοκλήρωση ζητούμενων! (100%)|
| 9 | [Συμμετοχικό περιεχόμενο B2](https://github.com/courses-ionio/hci/discussions/1838) |[ΠΑΡΑΔΟΤΕΟ 9](https://github.com/courses-ionio/help/discussions/1700), Απάντηση στις ερωτήσεις του Edpuzzle 9ης εβδομάδας, υλοποίηση Συμμετοχικού περιεχομένου Β2 με την [ΟΜΑΔΑ ΜΟΥ](https://github.com/OMADA12) |Ολοκλήρωση ζητούμενων! (100%)|
| 10 | [Άσκηση γραμμής εντολών](https://github.com/courses-ionio/hci/discussions/1839) |[ΠΑΡΑΔΟΤΕΟ 10](https://github.com/courses-ionio/help/discussions/1922), Απάντηση στις ερωτήσεις του Edpuzzle 10ης εβδομάδας, υλοποίηση Άσκησης γραμμής εντολών |Ολοκλήρωση ζητούμενων!|
| 11 | [Κατασκευή του βιβλίου Β](https://github.com/courses-ionio/hci/discussions/1840) |[ΠΑΡΑΔΟΤΕΟ 11](https://github.com/courses-ionio/help/discussions/1949), Απάντηση στις ερωτήσεις του Edpuzzle 11ης εβδομάδας, ολοκλήρωση κατασκευής του βιβλίου B|Ολοκλήρωση ζητούμενων!(100%)|
| 12 | [Τελική αναφορά*](https://github.com/courses-ionio/hci/discussions/1844) |[ΠΑΡΑΔΟΤΕΟ 12](https://github.com/courses-ionio/help/discussions/2056) |Ολοκλήρωση ζητούμενων! (100%) |
### Παραδοτέο 1ο:
## ΕΙΣΑΓΩΓΗ: 
...
=> [για τις εικόνες](https://github.com/OMADA12/images/pull/32)

=> [για τα md files μου](https://github.com/OMADA12/_gallery/pull/26)
...
=> [PLATO case-study](https://panmour.netlify.app//case-study/plato-cs/)

### Για το site μου στο Github:

=> [PLATO case-study](https://github.com/PanMour/site/blob/master/_case-study/plato-cs.md)
...
### Τα βίντεο στο Αsciinema:
  - [Convert Class_Report.md to html](https://asciinema.org/a/540288)
  - [Convert Class_Report.md to pdf](https://asciinema.org/a/540287)
  - [Convert my_book.epad to html](https://asciinema.org/a/540285)
  - [Convert my_book.epad to txt](https://asciinema.org/a/540284)
### Τα αρχικά μου αρχεία:
  - [Class_Report.md](https://github.com/PanMour/-8/blob/main/Class_Report.md)
  - [My_Book.epub](https://github.com/PanMour/-8/blob/main/my_book.epub)
  - [Convert.sh](https://github.com/PanMour/-8/blob/main/convert.sh)
### Τα αρχεία που προέκυψαν από τις μετατροπές:
  - [Class_Report.pdf](https://github.com/PanMour/-8/blob/main/Class_Report.pdf*)
  - [Class_Report.html](https://github.com/PanMour/-8/blob/main/Class_Report.html)
  - [My_Book.txt](https://github.com/PanMour/-8/blob/main/my_book.txt)
  - [My_Book.html](https://github.com/PanMour/-8/blob/main/my_book.html)
...
Μέσα από το μάθημα επικοινωνία ανθρώπου υπολογιστή, απέκτησα χρήσιμες νέες γνώσεις και ανακάλυψα πολλές καινούργιες ιδέες και τρόπους σκέψης, που εάν δεν το είχα παρακολουθήσει δεν γνωρίζω άμα θα μπορούσα να τα ανακαλύψω. 
Αρχικά όσον αφορά τις γνώσεις που απέκτησα στο κομμάτι του προγραμματισμού. Ήρθα σε επαφή με γραμμή εντολών, μέσω της Arch Linux, κάτι εντελώς πρωτοφανές για εμένα και αρκετά τρομακτικό. Όμως έπειτα από μεγάλη προσπάθεια και πολλές αποτυχίες κατάφερα να μάθω να την χρησιμοποιώ σε αρκετά καλό βαθμό. Επιπλέον ήρθα σε επαφή με το GitHub, που είναι ένας "παράδεισος" για τους πληροφορικούς, καθώς μας δίνει πρόσβαση σε τρομερά εργαλεία.
Όσον αφορά το κομμάτι των ιδεών, μέσω των εβδομαδιαίων βίντεο και των συζητήσεων κατά την διάρκεια του μαθήματος ήρθα σε επαφή με έναν καινούργιο τρόπο σκέψης. Πριν παρακολουθήσω το μάθημα επικοινωνία ανθρώπου υπολογιστή, δεν είχα συνειδητοποιήσει πόσο επικίνδυνη και καταστροφή είναι η απλοποίηση όλων των λειτουργιών για χάρη της διευκόλυνσης του χρήστη. Δεν γνώριζα ότι στερούσε την καλλιέργεια της κριτικής σκέψης και την ανάπτυξη προσωπικών στόχων, κάτι μέγιστης σημασίας, ειδικά για εμάς τους πληροφορικούς. 
Εν κατακλείδι, το βασικό συμπέρασμα μου από το μάθημα είναι η αξία της σκληρής δουλειάς για την κατάκτηση ικανοτήτων και η αποφυγή του εύκολου και απλού δρόμου που προσφέρεται πλέον στους σημερινούς ανθρώπους. Καθώς η αλληλεπίδραση με τον υπολογιστή πρέπει να έχει πάντα τον άνθρωπο στο επίκεντρο και όχι τους υπολογιστές, δηλαδή να υπάρχει ανθρωποκεντρικός σχεδιασμός.

# Προσωπική Αυτοαξιολόγηση:

=> 1o: Βαθμός Αυτοαξιολόγησης: 8/10. Η εισαγωγή χρειάστηκε αρκετές επιπλέον εβδομάδες για να ολοκληρωθεί και ακόμη και στην τελική της μορφή θεωρώ ότι δεν είναι απόλυτα ολοκληρωμένη.

=> 2o: Βαθμός Αυτοαξιολόγησης: 10/10. Η εγκατάσταση του Arch Linux ολοκληρώθηκε επιτυχώς και εντός του χρονικού περιθωρίου.

=> 3o: Βαθμός Αυτοαξιολόγησης: 8/10. Το παραδοτέο δεν ολοκληρώθηκε εμπρόθεσμα αλλά είχε γίνει σημαντική προσπάθεια πρώτου τελειώσει η προθεσμία. Υπήρξαν επίσης ριζικές αλλαγές έπειτα από συζήτηση στην τάξη

=> 4o: Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο ολοκληρώθηκε εντός του χρονικού περιθωρίου αλλά θα μπορούσα να εξασκηθώ περισσότερο εκτελώντας επιπλέον warm-ups.

=> 5o: Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο είχε ολοκληρωθεί εμπρόθεσμα άλλα υπήρξαν ριζικές αλλαγές έπειτα από συζήτηση στην τάξη.

=> 6o: Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο είχε ολοκληρωθεί εμπρόθεσμα άλλα υπήρξαν αλλαγές.

=> 7o: Βαθμός Αυτοαξιολόγησης: 8/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα άλλα υπήρξαν ριζικές αλλαγές έπειτα από συζήτηση στην τάξη.

=> 8o: Βαθμός Αυτοαξιολόγησης: 10/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα και με επιτυχία!

=> 9o: Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα.

=> 10o: Βαθμός Αυτοαξιολόγησης: 3/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα άλλα λόγω δικιάς μου παρεξήγησης δεν έχουν πραγματοποιηθεί όλα τα απαιτούμενα ζητούμενα.

=> 11o: Βαθμός Αυτοαξιολόγησης: 6/10. Το παραδοτέο ολοκληρώθηκε εκτός προθεσμίας λόγω τεχνικών δυσκολιών.

=> 12o: Βαθμός Αυτοαξιολόγησης: 9/10. Το παραδοτέο ολοκληρώθηκε εμπρόθεσμα.

# Σχολιασμός συζητήσεων:
## Σχόλια που έκανα:
