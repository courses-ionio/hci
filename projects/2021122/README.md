...
## Συμμετοχικό περιεχόμενο ( Α2 ):
 ...
 έχωντας πλέον εξοικειωθεί με το (git, GitHub, jekyll, cli) που είδαμε στα προηγούμενα παραδοτέα φτάνωντας στο 5ο παραδοτέο μας ζητήθηκε  ένα σετ από θεματικές διαφάνειες και ένα χρονολόγιο που συνδυάζει τις δύο νέες εικόνες από το  παραδοτέο Α1 της 3ης εβδομάδας
