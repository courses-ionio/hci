...
# 8ο Παραδοτέο
Επέλεξα την άσκηση γραμμής εντολών [](https://github.com/epidrome/dokey#hci). Ζητούμενο της άσκησης αυτής είναι: 1) η δημιουργία ενός status bar, η διαμόρφωσή του και 2) η αλλαγή φόντου που έχει το παράθυρο του τερματικού.
