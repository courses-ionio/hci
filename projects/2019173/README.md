...
| 3 | [Άσκηση γραμμής εντολών](https://github.com/p19pasa/hci/blob/%CE%A02019173/projects/2019173/README.md#2%CE%BF-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF)
...
Για να καταφέρω να καταλάβω πως δουλεύει το τερματικό σε συνδιασμό με τραγούδια του youtube και του mp3, χρησιμοποίησα πληροφορίες που βρήκα στην ιστοσελίδα [How to search for YouTube videos on Ubuntu Desktop](https://vitux.com/how-to-search-for-youtube-videos-on-ubuntu-desktop/). Επομένως, έχοντας επιπλέον γνώσεις ετοίμασα την άσκηση.
