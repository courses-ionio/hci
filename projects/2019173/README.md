...
# 1ο Παραδοτέο
-  Ανάγκες: Τί είναι το github; Πως θα μπορούσα να το χρησιμοποιήσω; Η χρήση του github ήταν άγνωστη και χωρίς τη καθοδήγηση του διδάσκοντα θα ήταν ιδιαίτερα δύσκολη. Κύρια ανάγκη είναι η επίτευξη της εξοικείωσης με τα προγράμματα Linux, το terminal. Επίσης, θα πρέπει να αναπτυχθούν οι δεξιότητες στην σχεδίαση και ανάπτυξη της διάδρασης, καθώς απαιτείται από το μάθημα.
