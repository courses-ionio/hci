...
| 6 | [Συμμετοχικό περιεχόμενο: Α1) δύο εικόνες που συνδέονται με το μάθημα με λεζάντες  και Α2) σετ διαφανειών και χρονολόγιο που σχετίζονται με τις εικόνες](https://github.com/p19pasa/hci/blob/%CE%A02019173/projects/2019173/README.md#6%CE%BF-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF)
...
# 6ο Παραδοτέο
Με βάση τις οδηγίες βρήκα δύο εικόνες που σχετίζονται με 
