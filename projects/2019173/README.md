...
Για το βιντεοπαιχνίδι: [το σετ με τις διαφάνειες είναι αυτό](https://github.com/p19pasa/site/blob/master/_slides/assassin-s-creed.md) και [το χρονολόγιο είναι αυτό](https://github.com/p19pasa/site/blob/master/_timeline/assassin's%20creed.md).

Για τη γλώσσα προγραμματισμού: [το σετ με τις διαφάνειες είναι αυτό](https://github.com/p19pasa/site/blob/master/_slides/java.md) και [το χρονολόγιο είναι αυτό]().
