...
Η επαναλαμβανόμενη και συχνή τριβή με τα μέσα και τις γλώσσες προγραμματισμού, που χρειάζονται για να λυθούν οι διαφορετικές ασκήσεις προγραμματισμού, επέφερε μία καλή γνώση τρόπου λύσεις των ασκήσεων. Έτσι, δεν αντιμετώπισα κάποιο ιδιαίτερο πρόβλημα στα βήματα λύσης της συγκεκριμένης άσκησης. Αρχικά, μελέτησα τους κώδικες και κατάλαβα τι επιτελεί ο καθένας από αυτούς. Έπειτα, τροποποίησα τον κώδικα, που είναι γραμμένος σε CSS, και κατάφερα να κάνω το φόντο των αντικειμένων μπλε, τα γράμματα άσπρα, μεγάλωσα τα πλαίσια σε ύψος της λίστας και μίκρυνα την απόσταση του ενός πλαισίου με το άλλο, ώστε να μην φαίνονται κενά. Το τελικό αποτέλεσμα βρίσκεται στον ακόλουθο σύνδεσμο: ().   
