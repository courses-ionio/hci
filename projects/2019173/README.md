...
| 12 | [Τελική αναφορά* και αίτημα ενσωμάτωσης: Σύνοψη εργασίας](https://github.com/p19pasa/hci/blob/%CE%A02019173/projects/2019173/README.md#%CF%84%CE%B5%CE%BB%CE%B9%CE%BA%CE%AE-%CE%B1%CE%BD%CE%B1%CF%86%CE%BF%CF%81%CE%AC)
...
-  Ανάγκες: Η χρήση του github ήταν άγνωστη και χωρίς τη καθοδήγηση του διδάσκοντα θα ήταν ιδιαίτερα δύσκολη. Κύρια ανάγκη είναι η επίτευξη της εξοικείωσης με τα προγράμματα Linux, το terminal. Επίσης, θα πρέπει να αναπτυχθούν οι δεξιότητες στην σχεδίαση και ανάπτυξη της διάδρασης, καθώς απαιτείται από το μάθημα και από τον κόσμο του προγραμματισμού.
...
# 4ο Παραδοτέο
Στο τέταρτο παραδοτέο επέλεξα να κάνω την άσκηση προγραμματισμού [Menu pie](https://pibook.epidro.me/remix/menu-pie/). Στη συγκεκριμένη άσκηση υπάρχει ένα μενού με 12 επιλογές και μας ζητείται να τροποποίησουμε το πρόγραμμα, έτσι ώστε στο μενού να υπάρχουν 4 επιλογές.
...
# 5ο Παραδοτέο
Για το παραδοτέο αυτό διάλεξα την άσκηση γραμμών εντολής [become productive with a todo list](https://github.com/epidrome/dokey#warmup). Ζητούμενα της άσκησης ήταν να δημιουργήσουμε μέσω του τερματικού μία λίστα todo.txt και να την επεξεργαστούμε, προστέθοντας και αφαιρώντας εργασίες που πρέπει να πραγματοποιηθούν. Επίσης, έπρεπε να δειχτεί ότι κάποιες από αυτές έγιναν. 
...
Αυτό επιτυγχάνεται με χρήση κώδικα που υπάρχει στην άσκηση Image processing. Έτσι, δεν εμφανίστηκαν προβλήματα και με τις κατάλληλες προσθέσεις κώδικα στο codepen η λύση της άσκησης επιτεύχθηκε.

Η λύση της άσκησης βρίσκεται στο παρακάτω σύνδεσμο (https://github.com/p19pasa/site/blob/master/_remix/image-zoom.md).
...
- 1ο: Αναφορά στις ανάγκες και τους στόχους του φοιτητή και στις προσδοκίες του μαθήματος. Το παραδοτέο υποβλήθηκε εγκαίρως.  
- 2ο: Άσκηση προγραμματισμού: [Mouse Form](https://pibook.epidro.me/remix/mouse-form/). Το παραδοτέο υποβλήθηκε εγκαίρως.  
- 3ο: Άσκηση γραμμής εντολών: [get familiar with basic commands, reading documentation and editing files](https://github.com/p19pasa/dokey/blob/master/README.md). Το παραδοτέο υποβλήθηκε εγκαίρως.
- 4ο: Άσκηση προγραμματισμού: [Menu pie](https://pibook.epidro.me/remix/menu-pie/). Το παραδοτέο υποβλήθηκε εγκαίρως. 
- 5ο: Άσκηση γραμμής εντολών: [become productive with a todo list](https://github.com/epidrome/dokey). Το παραδοτέο υποβλήθηκε εγκαίρως.
- 6ο: Συμμετοχικό περιεχόμενο: Α1) δύο εικόνες με λεζάντες, που συνδέονται με το μάθημα και Α2) σετ διαφανειών και χρονολόγιο που σχετίζονται με τις εικόνες. Υπήρξε καθυστέρηση του παραδοτέου, επειδή το συγκεκριμένο παραδοτέο ήθελε πολύ μελέτη για να γίνει σωστά και υπήρξε σταδιακή ολοκλήρωσή του.
- 7ο: Άσκηση προγραμματισμού: [Image zoom](https://pibook.epidro.me/remix/image-zoom/). Το παραδοτέο υποβλήθηκε εγκαίρως.
- 8ο: Άσκηση γραμμής εντολών: [add a status bar to your shell/editor and configure a color-theme](https://github.com/epidrome/dokey#hci). Υπήρξε καθυστέρηση του παραδοτέου, επειδή το συγκεκριμένο παραδοτέο ήθελε πολύ μελέτη για να γίνει σωστά και υπήρξε σταδιακή ολοκλήρωσή του.
- 9ο: Άσκηση προγραμματισμού: [Sortable list](https://pibook.epidro.me/remix/sortable-list/). Το παραδοτέο υποβλήθηκε εγκαίρως.
- 10ο: Άσκηση γραμμής εντολών: [text editor and plug-ins for code highlighting and autocompletion](https://github.com/epidrome/dokey#hci). Το παραδοτέο υποβλήθηκε εγκαίρως.
- 11ο: Συμμετοχικό περιεχόμενο: Β1) μια νέα μελέτη περίπτωσης και Β2) μια νέα βιογραφία. Το παραδοτέο υποβλήθηκε εγκαίρως.

Σε κάθε παραδοτέο ακολουθούσα πιστά τις οδηγίες και ανάλογα με τα ζητούμενα της άσκησης, πραγματοποιούσα και την αντίστοιχη σειρά βημάτων επίλυσης.

#### Αποτελέσματα που επιτεύχθηκαν:

Με σιγουριά μπορώ να πω ότι το μάθημα της Επικοινωνίας Ανθρώπου-Υπολογιστή σε συνδιασμό με την εργασία με εμπλούτησε με γνώσεις και μου έμαθε πως όταν θέλω να πραγματοποιήσω κάτι στον τομέα της Πληροφορικής, όπως μία εργασία, θα πρέπει να είμαι οργανωμένη και να αναζητώ συνεχώς τη γνώση. Επομένως, έχω μάθει να χειρίζομαι ολοκληρωμένα την ιστοσελίδα του github, που θα μου είναι χρήσιμη και κατάφερα να δουλεύω για παράδειγμα με το τερματικό, πράγμα που είναι ιδιαίτερα απαραίτητο για έναν προγραμματιστή. Έτσι, οι προσδοκίες του μαθήματος και οι ανάγκες μου ήρθαν εις πέρας.
