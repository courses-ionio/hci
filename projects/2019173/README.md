...
| 7 |  [Άσκηση προγραμματισμού: ](https://github.com/p19pasa/hci/blob/%CE%A02019173/projects/2019173/README.md#7-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF)
...
# 7 Παραδοτέο
Για το έβδομο παραδοτέο διάλεξα την άσκηση προγραμματισμού [Image zoom](https://pibook.epidro.me/remix/image-zoom/). Η άσκηση αυτή δίνει μία κυκλική εικόνα και ζητάει κάθε φορά που περνάει το ποντίκι πάνω από αυτήν, να κάνει μεγέθυνση και να της αλλάζει το χρώμα. 

#### Τρόπος επίλυσης της άσκησης:
Αυτό επιτυγχάνεται με χρήση κώδικα που υπάρχει στην άσκηση Image processing. Έτσι, δεν εμφανίστηκαν προβλήματα και με τις κατάλληλες προσθέσεις κώδικα στο codepen η λύση της άσκησης επιτεύχθηκε κι είναι η εξής: 
