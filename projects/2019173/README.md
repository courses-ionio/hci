...
Για τη γλώσσα προγραμματισμού: [το σετ με τις διαφάνειες είναι αυτό](https://github.com/p19pasa/site/blob/master/_slides/java.md) και [το χρονολόγιο είναι αυτό](https://github.com/p19pasa/site/blob/master/_timeline/java.md).
