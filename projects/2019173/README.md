...
Για να καταφέρω να καταλάβω πως δουλεύει το τερματικό σε συνδιασμό με τραγούδια του youtube και του mp3, χρησιμοποίησα πληροφορίες που βρήκα στις ιστοσελίδες [How to search for YouTube videos on Ubuntu Desktop](https://vitux.com/how-to-search-for-youtube-videos-on-ubuntu-desktop/) και [How do I play music from the terminal?](https://askubuntu.com/questions/82605/how-do-i-play-music-from-the-terminal). Επομένως, έχοντας επιπλέον γνώσεις ετοίμασα την άσκηση.
