...
Σχετικά με τις ανάγκες μου από της αρχή του εξαμήνου, θεωρώ ότι έχουν εκπληρωθεί σε ικανοποιητικό βαθμό. Έχω κατανοήσει τις έννοιες σχετικά με την διάδραση χρήστη-υπολογιστή και γνωρίζω τις πρακτικές χρήσεις της. Παρόλο που η μορφή και η δομή του μαθήματος ήταν διαφορετική από αυτήν που περίμενα αρχικά, έμαθα να χρησιμοποιώ νέα εργαλεία, καινούργιες γλώσσες προγραμματισμού αλλά και άρχισα να μαθαίνω σχετικά με το linux. Μέσω των εργασιών προγραμματισμού, έχω πλέον μεγαλύτερη κατανόηση των HTML, CCS και Javascript. Το συμμετοχικό περιεχόμενο μου έδωσε την δυνατότητα να αναπτυχθώ σε ένα θέμα που με ενδιαφέρει και να εμπλουτίσω τις γνώσεις μου. Βρισκόμουν στις διαλέξεις των μαθημάτων και παρέδιδα τα παραδοτέα έγκαιρα, οπότε θεωρώ σε αυτό το κομμάτι είμαι πλήρως καλυμμένος. Σαν μάθημα μου έχει φανεί ήδη χρήσιμο καθώς έχω χρησιμοποιήσει ήδη τις γνώσεις μου σε άλλα μαθήματα.
