...
Αρχικά είχα ξεκινήσει να κάνω την αναφορά μου στο hci-lab fork μου και από εδώ είναι το [ιστορικό](https://github.com/p19kala/hci-lab/commits/%CE%A02019017?after=9473a2524c479c9c475b31f929ac00e9db6c2dfe+34&branch=%CE%A02019017&path%5B%5D=projects&path%5B%5D=2019017). Όλα τα commits έγιναν μέσα στη διορία για κάθε παραδοτέο.
