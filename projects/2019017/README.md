...
## Συμπεράσματα
Οι αρχικοί στόχοι μου δεν καλύπτηκαν όλοι. Σε κάθε διάλεξη μιλούσαμε για την ιστορία των διεπαφών και παλιών συσκευών/υπολογιστών/λογισμικών (Xerox Star, Sketchpad, ποντίκι με 1 κουμπί, η πρώτη επιφάνεια εργασίας) οπότε αυτό εκπληρώθηκε. Περίμενα να μάθουμε κι εμείς πώς να δημιουργούμε ένα interface, αλλά ίσως αυτό ήταν πολύ προχωρημένο για το έτος μας. Εξοικοιώθηκα με το περιβάλλον Linux καθώς χρειάστηκε στις ασκήσεις και είχα αρκετή βοήθεια από το εργαστήριο. Οι προσδοκίες μου από το μάθημα τελικά ήταν διαφορετικές από αυτό που περίμενα. Νόμιζα θα κάναμε και το τρόπο που επικοινωνεί ο υπολογιστής με τον άνθρωπο από την οπτική γωνία της αρχιτεκτονικής και λογισμικού του (ο υπολογιστής μετατρέπει κάθε ενέργειά μας σε 0 και 1 και μόνο έτσι τις καταλαβαίνει, αλλά πως ακριβώς γίνεται αυτό). Αυτό ήταν μάλλον από τη δική μου πλευρά λάθος ερμηνεία των στόχων στη σελίδα του μαθήματος [εδώ](https://di.ionio.gr/gr/studies/undergraduate-studies/courses/591/).
