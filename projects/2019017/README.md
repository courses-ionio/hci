...
Χρησιμοποίησα τις εντολές "--extract-audio" και "--audio-format mp3" για να κατεβάσω το βίντεο μόνο σε mp3 μορφή. Έπειτα έβαλα την εντολή "-o" και ένα custom filename μέσα στα μονά εισαγωγικά. Στο τέλος είναι το id του βίντεο. Αφού ξεκίνησε η αναπαραγωγή, περίμενα 7-8 δευτερόλεπτα και το σταμάτησα πατώντας το "Q".
