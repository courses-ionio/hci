...
UPDATE: Άλλο ένα πρόβλημα που μου εμφανίστηκε ήταν το _config.yml στο site fork μου έπρεπε να αλλάξω το url και το repository στα δικά μου ωστε να δουλέψει σωστά και να μου εμφανίσει τις εικόνες μου.
