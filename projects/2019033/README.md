...
| 2 | [Άσκηση προγραμματισμού](https://codepen.io/tsimpliarakis/pen/MWeeroz) |
...
Link άσκησης: https://codepen.io/tsimpliarakis/pen/MWeeroz
...
Για την συγκεκριμένη εργασία έλαβα βοήθεια απο w3schools.com καθώς και το geeksforgeeks.org, πέρα απο τις προυπάρχουσες γνώσεις που είχα.
