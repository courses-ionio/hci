...
### Η ομάδα μου: [XorisOnoma](https://github.com/XorisOnoma)
<br />
...
| --- | --- | --- | --- |
| 1 | [Παραδοτέο 1ο:](#εισαγωγή) [Δημιουργία ομάδας](https://github.com/courses-ionio/hci/discussions/1794) + [Φορκ και δημιουργία σελίδας τελικής αναφοράς](https://courses-ionio.github.io/help/guide/), [προσθήκη πίνακα περιεχομένων](https://raw.githubusercontent.com/courses-ionio/hci/master/README.md), [συγγραφή της εισαγωγής](#εισαγωγή), αποστολή της εισαγωγής [για σχολιασμό στην συζήτηση](https://github.com/courses-ionio/help/discussions/categories/show-and-tell) και καταγραφή του συνδέσμου συζήτησης δίπλα --> | https://github.com/courses-ionio/help/discussions/829 | Ολοκληρώθηκε |
| 2 | [Άσκηση γραμμής εντολών (linux install)](#linux-install) | https://github.com/courses-ionio/help/discussions/1015 | Ολοκληρώθηκε |
| 3 | [Συμμετοχικό περιεχόμενο A1](#τρίτο-παραδοτέο) | https://github.com/courses-ionio/help/discussions/1421 | Ολοκληρώθηκε |
| 4 | [Άσκηση γραμμής εντολών: warm up cli](#warm-up-cli) | https://github.com/courses-ionio/help/discussions/1422 | Ολοκληρώθηκε |
| 5 | [Συμμετοχικό περιεχόμενο A2](#πέμπτο-παραδοτέο) | https://github.com/courses-ionio/help/discussions/1426 | Ολοκληρώθηκε Μερικώς |
| 6 | [Κατασκευή του βιβλίου Α](#κατασκευή-του-βιβλίου-α) | https://github.com/courses-ionio/help/discussions/1505 | Ολοκληρώθηκε |
| 7 | [Συμμετοχικό περιεχόμενο B1](#έβδομοδο-παραδοτέο) | https://github.com/courses-ionio/help/discussions/1750 | Ολοκληρώθηκε |
| 8 | [Άσκηση γραμμής εντολών](#όγδοο-παραδοτέο) | https://github.com/courses-ionio/help/discussions/1751 | Ολοκληρώθηκε |
| 9 | [Συμμετοχικό περιεχόμενο B2](#ένατο-παραδοτέο) | https://github.com/courses-ionio/help/discussions/1752 | Ολοκληρώθηκε |
| 10 | [Άσκηση γραμμής εντολών](#δέκατο-παραδοτέο) | https://github.com/courses-ionio/help/discussions/2032 | Ολοκληρώθηκε |
| 11 | [Κατασκευή του βιβλίου Β](#εντέκατο-παραδοτέο) | https://github.com/courses-ionio/help/discussions/1950 | Ολοκληρώθηκε |
| 12 | [Τελική αναφορά*](#συμπεράσματα) | https://github.com/courses-ionio/help/discussions/2033 | Ολοκληρώθηκε |

## Πρώτο Παραδοτέο

## Εισαγωγή

Οι στόχοι μου για αυτό το μάθημα είναι πολλαπλοί:
1. Θέλω με το έργο που θα καταθέσω μέσω github να κατανοήσω την πλατφόρμα σε βαθμό κατα τον οποίο θα έχω την ευχέρεια να ανεβάσω εργασίες προηγούμενων εξαμήνων καθώς και πρακτικής άσκησης/πτυχιακής για την ανάπτυξη ενός πορτφόλιου. Έτσι σε συνεντεύξεις για εργασία θα μπορώ να δείξω την δουλειά μου οργανωμένη κάτω από ένα προφίλ.
2. Ευελπιστώ να κατασκευάσω μια εφαρμογή/παιχνίδι για την εκπαίδευση λογοτεχνίας σε παιδια γυμνασίου. Θέλω μετά από την ολοκλήρωση του μαθήματος να γνωρίζω σε τι διεπαφές να στηριχτώ κατα την εκπόνηση της πτυχιακής εργασίας έτσι ώστε να έχει μεγαλύτερη πιθανότητα επιτυχίας.
3. Θέλω το περιβάλλον archlinux που θα χτίσω για τα παραδοτέα γραμμής εντολών να έχει κάποιας μορφής UI καθώς όχι με είχε δυσκολέψει σε προηγούμενες χρονιές η απουσία του αλλά είχα αποτύχει να το προσθέσο στο λειτουργικό μου.

Ως φοιτήτρια η οποία δεν είχε την δυνατότητα να βρίσκεται κέρκυρα αυτή την χρονιά ήταν δύσκολο να αναζητήσω ομάδα.
...
https://asciinema.org/a/95Xtm21UmuHVzyd8kwu4gnbIs

https://asciinema.org/a/528702

Έχοντας συναντήσει πολλές δυσκολίες και φέτος και σε προηγούμενα έτη κατα την εγκατάσταση οπότε άνοιξα ένα show and tell discussion στο courses-ionio/help με τα προβλήματα που συνάντησα και πώς τα έλυσα καλώντας και συμφοιτητές μου να μοιραστούν την δικιά τους εμπειρία εγκατάστασης τόσο σε Virtual box όσο και σε φυσικό δίσκο.

## Τρίτο παραδοτέο
Για το τρίτο παραδοτέο ήθελα το συμμετοχικό υλικό να συνάδει με τον προσωπικό μου στόχο εμβάθυνσης γνώσεων σχετικά με διεπαφές που βοηθούν στην εκπαίδευση. Η πρώτη εικόνα που επέλεξα είναι για την οπτική γλώσσα προγραμματισμού AgentCubes καθώς θεωρώ ότι η οικειοποίηση μου με ένα τέτοιο εκπαιδευτικό εργαλείο θα με βοηθήσει να καταλάβω καλύτερα ποια στοιχεία του βοηθούν στην εκπαίδευση μέσω δεξιοτήτων πληροφορικής. Έχοντας χρησιμοποιήσει το scratch στο γυμνάσιο θυμάμαι ότι ως μαθήτρια τα project μας ήταν όμοια και πολύ περιοριστικά.Θεώρησα λοιπόν ότι ,συγκριτικά με το scratch, το τελικό project του κάθε μαθητή στο AgentCubes μπορεί να έχει πολύ μεγαλύτερες δυνατότητες και έκφραση ανα μαθητή. 

## Συμμετοχικό υλικό Α1

## Πρώτη εικόνα

![AgentCubes-thumb](https://user-images.githubusercontent.com/43947917/201078347-5337800d-267e-48bf-938c-893559ce91bc.jpg)

| author | p17mari |
| -- | -- |
| netlify | https://p17mari-book.netlify.app/gallery/agentcubes/ |
...
| license_text | 
| categories | Εργαλεία και Τεχνολογίες, Εκπαιδευτική Τεχνολογία |
| tags | AgentSheets, scratch, Logo |
| netlify |  |

## Δεύτερη εικόνα

![legomindstorms-thumb](https://user-images.githubusercontent.com/43947917/201078273-fd09d33d-22d1-499b-bf4b-ed694aa98c34.jpg)

| author | p17mari |
| -- | -- |
| netlify url | https://p17mari-book.netlify.app/gallery/legomindstorms/ |
...
| license_text |
| categories | Εργαλεία και Τεχνολογίες, Εκπαιδευτική Τεχνολογία |
| tags | Lego Mindstorms, Seymour Papert, Logo |
...
Φίλτρο lua [student-contribution.lua](https://github.com/p17mari/kallipos/blob/master/studentcontribution.lua)
