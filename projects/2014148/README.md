...
δεν ήταν λίγες οι φορές που μπορεί να κολλούσα σε κάποιο σημείο των παραδοτέων μου. Χαρακτηριστικό παράδειγμα ειναι η άσκηση με τα submodules όπου μου πήρε αρκετό καιρό. Παρατήρησα όμως πως και μόνο η διαδικασία που θα μπεί κάποιος να μεταφέρει το πρόβλημα που αντιμετωπίζει ώστε  να γίνει αντιληπτό απο τους συμφοιτητές του, αποσαφηνίζει αυτόματα και στο μυαλό του την υπάρχουσα κατάσταση, και τον βοηθάει να βρεί μόνος του την λύση στο πρόβλημα που αντιμετωπίζει. Εκτός των άλλων διαβάζοντας και τις λύσεις που προτίνουν οι συμφοιτητές σε άλλα προβλήματα, βοηθούσε στο να δω μια άλλη οπτική στην αντιμετώπιση παρόμοιων προβλημάτων που είχα εγω.Επίσης, στο πλαίσιο της συνεργασίας, θα ήθελα να κάνω και μια αναφορά στην εντύπωση που μου έκαναν οι μεγάλες κοινότητες τόσο το arch-wiki όσο και το reddit, που όπως κατάλαβα αποτελούνται απο χιλιάδες ανθρώπους, πρόθυμους να συνεργαστούν και να αλληλοβοηθιθούν.Κλείνοντας σε αυτό το σημείο τον επίλογο με το κομμάτι της αυτοαξιολόγησης,θα ήθελα να αναφέρω πως το συγκεκριμένο μάθημα (έχοντας 220 ectc) είναι το τελευταίο χρωστούμενο μου. Οπότε με στόχο την επιτυχή παρακολούθηση του ώστε να δηλωθεί η πτυχιακή που πραγματοποιώ αυτό το διάστημα, προσπάθησα στην πραγματοποίηση των εργασιών να είμαι όσο γίνεται πιο τυπικός και να πραγματοποιηθούν αν οχι όλα τότε τα περισσότερα ζητούμενα.
