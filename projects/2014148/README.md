...
# Εβδομάδα 9
 ...
 # Εβδομάδα 12 
 ### Τελική αναφορά
   Φτάνοντας στο τέλος του εξαμήνου γράφω τα συμπεράσματα απο όλες τις διαδικασίες του μαθήματος που ακολουθήσαμε. Αρχικά μπορώ να πω πως οι στόχοι που περιγράφτηκαν στην αρχή της αναφοράς, καλύφθηκαν σε πολύ μεγάλο βαθμό. Ξεκινόντας απο την αμφιβολία που είχα σχετικά με το εργαλείο του github και το κατα πόσο εγω θα μπορούσα να ανταποκριθώ στις απαιτήσεις του μαθήματος αφου δεν είχα μεγάλη εξοικείωση με αυτό, θεωρώ πως αντιμετωπίστηκε σχετικά εύκολα και με μικρή βοήθεια απο το youtube μέσω tutorials οτι δυσκολία και αν  εμφανίστηκε. Στην συνέχεια, η διαδικασία εγκατάστασης linux λειτουργικού ήταν μια ιδιαίτερη διαδικασία αφού το μόνο λειτοργικό που είχα χρησιμοποιήσει μέχρι τν συγκεκριμένη χρονική στιγμή ήταν τα windows. Το ενδιαφέρον κομμάτι της συγκεκριμένης διδικασίας ήταν οτι η εγκατάσταση δεν συμβαίνει με αυτοματοποιημένο τρόπο, αλλά τα partition, τα fylesystems και τα σχετικά τα καθορίζει ο ίδιος ο χρήστης. Ενδιαφέρον παρουσίασαν και όλες οι ενέργειες που κάναμε  στα πλαίσια του μαθήματος, προκειμένου να γίνει κατανοητή η έννοια της επικοινωνίας του ανθρώπου με έναν υπολογιστή. Για να επιτευχθεί αυτό πραγματοποιήθηκαν ενδδιαφέρουσες δια ζώσης κουβέντες και παρακολουθήσαμε βίντεο με αναγνωρισμένους ομιλητές στο κομμάτι της διάδρασης όπως ο Alan Kay. Επιπλέον, και μέσω των ασκήσεων των γραμμών εντολών θεωρώ πως οι προγραμματιστικές μου ικανότητες βελτιώθηκαν. Άξιο αναφοράς είναι και το συμμετοχικό περιεχόμενο αφού μου έδωσαν μια πρώτη εικόνα για το πως λειτουργεί μια συντήρηση ένος έργου συνεργατικά. Τέλος, ιδιαίτερη αναφορά θα ήθελα να κάνω στο κομμάτι της συνεργασίας και της επικοινωνίας. Μπορεί ο ίδιος προσωπικά να μην χρειάστηκε να ανεβάσω κάποιο συγκεκριμένο ερώτημα στο discusions, όμως 
