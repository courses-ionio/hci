...
| 9 | Άσκηση γραμμής εντολών: Use vim to write your cv. <sup><a href="#9">[ΠΑΡΑΔΟΤΕΟ 9]</a></sup>|
...
* [Link βιβλιογραφίας στα extras](https://github.com/pibook/extras/blob/2c4e61e9be27bad0a16d9f6c6909a377bcdb323b/cs-diegetic-nondiegetic.md)
...
Μέσα από αυτήν την εργασία και την ταυτόχρονη παρακολούθηση του μαθήματος κατάφερα να εξασκηθώ στα εξής
 - Aξιοποίηση των εργαλείων (github) και των λειτουργιών του (Όλες οι εργασίες έγιναν μέσω εντολών git από το terminal)
   - Δυνατότητες συνεργασίας (Κατανόηση git submodules)
   - Ανίχνευση σφαλμάτων (Κατόπιν τακτικών συναντήσεων με τους διδάσκοντες)
   - Διαχείρηση εργασιών  (Μέσω αποθετηρίου site)
 - Oικοδόμηση γνώσης για την κατασκευή διαδραστικών πρωτοτύπων και εφαρμογών.
 Για την υλοποίηση των προτύπων αυτών ήταν απαραίτητες κάποιες προϋποθέσεις, η κυριότερη από τις οποίες ήταν η καθημερινή προετοιμασία ώστε να είμαστε γνωστικά και πρακτικά έτοιμοι να αξιοποιήσουμε τα εργαλέια αυτά στην πράξη.<br/>
