...
### Παραδοτέα που παραδόθηκαν:
 ...
 - 10ο Παραδοτέο: Άσκηση γραμμής εντολων(επεξεργασία ενός status bar και του color theme).Καθυστέρυση λόγω δυσκολίας ολοκήρωσης πλήρως τηε άσκησης.
 - 11ο Παραδοτέο: Συμμετοχικό περιεχόμενο(προσθήκη μελέτης περίπτωσης και βιογραφίας).Υπήρξε καθυστέρυση λόφω δυσκολιάς χρήσης του git για τα submodules.
