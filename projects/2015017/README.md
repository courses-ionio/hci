...
<h2>ΠΑΡΑΔΟΤΕΟ 7</h2>
Για το 7ο παραδοτέο, επέλεξα μία μελέτη περίπτωσης για την επιστήμη της πληροφορικής και την ανέπτυξα βάζοντας το κυρίως περιεχόμενο στα includes του site. Παρακάτω παραθέτω τους συνδέσμους για την μελέτη περίπτωσης, για το markdown αρχείο και για τα includes στα οποία εμπεριέχεται το κείμενο.
