...
# ΕΙΣΑΓΩΓΗ
Στην αρχή του συγκεκριμένου μαθήματος, οι προσδοκίες μου ήταν αρκετά ακαθόριστες χωρίς κάποιο ιδιαίτερο σκοπό ενώ περιορίζονταν μόνο στην εκμάθηση εντολών και τη δημιουργία κώδικα. Καθώς συνέχιζα την εκπόνηση των παραδοτέων κατάλαβα ότι το μάθημα πραγματέυται κάτι περισσότερο απο αυτό και μέσα από την αναζήτηση πληροφοριών, την επαφή μου με διαχρονικά συστήματα και διάφορους τρόπους διάδρασης με τον χρήστη, αυτό που μου τράβηξε το ενδιαφέρον ήταν η ανθρωποκεντρική προσέγγιση που έκανε τη διάδραση να έχει κάποιο ιδιαίτερο νόημα για τον άνθρωπο. 

- 1ος και κύριος στόχος μου σε αυτό το μάθημα έίναι η μελέτη της εργονομίας ενος συστήματος γιατί θέτει τις ανάγκες και τις δυνατότητες του ανθρώπου στο επίκεντρο του σχεδιασμού, κάτι που θέλω να αποτυπώσω αργότερα στην δημιουργία ενός δικού μου συστήματος.
