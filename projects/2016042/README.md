...
# Παραδοτέο 7
  Για το Παραδοτέο 7, διάλεξα να κάνω μια μελέτη περίπτωσης για τον HP 150 Touchscreen Computer καθώς είναι ένα ολοκληρωμένο σύστημα με ιδιαίτερα χαρακτηριστικά για την εποχή του 1980 αλλά πιο συγκεκριμένα γιατί ήθελα να μπω εις βάθος και να αναλύσω τον τρόπο με τον οποίο έφτιαξαν και ενσωμάτωσαν αυτά τα χαρακτηριστικά όπως η οθόνης αφής.
