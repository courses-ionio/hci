...
### Οι Στόχοι μου
* Ο βασικός μου στόχος είναι, μετά την επίτευξη του μαθήματος είναι να χρησιμοποιήσω το github για τα μελόντικα μου projects ώστε να τα έχω διαθέσιμα για το κοινό αλλά και να βοηθηθώ από άλλους προγραμματιστές ανά τον κόσμο για την επίτευξή των projects μου αλλά και την βελτίωση τους. Και επίσης να τους βοηθήσω και εγώ στα δικά τους.
...
### Παραδοτέο 12 Επίλογος 
 * Μετά από αυτές τις εβδομάδες του μαθήματος μπορώ να πω ότι έχω εξικοιωθεί απίστευτα πολυ με το github αλλά και με το τερματικό το οποίο πλεόν το χρησιμοποιώ σε καθημερινή βάση και μου έχει κάνει την ζωή μου πιο εύκολη και καθώς το όποιο έφύγα από ττην αγαπημένη Microsoft και πλέον έχω μόνο Linux. Έχω φτιάξει όλα τα απαρέτητα για εμένα scripts και κάνω πολλες διεργασίες πολύ πιο γρήφορα από ότι πριν και τώρα τρέχω ένα projects για να κατασκευάσω για προσοπηκούς λόγους ένα site με την χρήση των submodules. Μέσα από τα βίντεο έμαθα πάρα πολλά πράγρατα τα οποία δεν ήξερα.
