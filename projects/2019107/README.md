...
αρκετά ενθουσιασμένος. 
 <br> <br>Απο το πρώτο μάθημα ο καθηγητής μας, μας ενημέρωσε οτι πέρα απο ολα αυτά που είχα ελπίδες να μάθω, θα μαθαίναμε και πώς να γράφουμε γραμμές εντολών σε ένα πρωτόγρωρο για 
 ...
 μόνο στην εγκατάσταση αλλα και στην λειτουργία μιας βασικής ,για τις ασκήσεις, εφαρμογή.Παρά τις αμέτρητες ώρες μου προσπάθησα με την βοήθεια συμφοιτητών μου
