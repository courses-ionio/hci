...
| 12 | Τελική αναφορά* |
  ...
  Το συγκεκριμένο embed του codepen αποτελεί την πρώτη άσκηση προγραμματισμού με τίτλο <<Mouse form>>: <p class="codepen" data-height="265" data-theme-id="light" data-default-tab="html,result" data-user="p19pasc" data-slug-hash="rNLLOwd" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="2019110">
