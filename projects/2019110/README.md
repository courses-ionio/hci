...
| 12 | Τελική αναφορά* |
  ...
  Το συγκεκριμένο embed του codepen αποτελεί την πρώτη άσκηση προγραμματισμού : <p class="codepen" data-height="265" data-theme-id="light" data-default-tab="html,result" data-user="p19pasc" data-slug-hash="rNLLOwd" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="Mouse form(2019110)">
  <span>See the Pen <a href="https://codepen.io/p19pasc/pen/rNLLOwd">
  Mouse form(2019110)</a> by P2019110 (<a href="https://codepen.io/p19pasc">@p19pasc</a>)
