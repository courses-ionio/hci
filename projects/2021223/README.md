...
2) Υπηρξε πρόβλημα με την δέσμευση μνήμης από το λειτουργικό σύστημα των Windows που όταν έφτασα στην εγκατάσταση και την δημιουργία του FileSystem και του Linux Swap όπου με την βοήθεια της ομάδας μου, διαφόρων βίντεο και διαφόρων forum 
