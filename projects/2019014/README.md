...
Για το 11 παραδοτέο μας ζητήθηκε να εκτυπώσουμε το βιβλίο που κάναμε στο 6ο παραδοτέο με την προσθήκη μας, αλλά αυτη τη φορά σε μορφή epub. Εγώ δυστήχως δεν κατάφερεα λόγω corrupted αρχείων και αναγκάστηκα να επαναγκαταστήσω απο την αρχή το λογισμικό και μεγάλο λάθος μου που δεν έφτιαξα backup αρχεία 
