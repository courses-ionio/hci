...
Στο δεύτερο κομμάτι του συμμετοχικού περιεχομένου, θα κάνω την βιογραφία ενός προσώπου του οποίου έφερε στο φως ένα εντελώς διαφορετικό είδος διάδρασής μεταξύ ανθρώπου και υπολογιστή. Μία διάδραση η οποία σήμερα έχει εξελιχθεί αρκετά ώστε να μπορούμε να χρησιμοποιήσουμε ολόκληρο το σώμα μας για να έχουμε μια ρεαλιστική και ακριβής διάδραση λόγως της μεγάλης έμπνευσης που είχε σε αυτόν τον τομέα.

## Φωτογραφίες

https://github.com/Vasilakious/images/blob/p2020132/jaronlanier.jpg
Άδεια φωτογραφίας: https://en.wikipedia.org/wiki/Jaron_Lanier#/media/File:Jaron_Lanier_in_2010.jpg
