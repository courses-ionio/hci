...
Σε αυτό το αρχείο περιέγχονται και οι 6 ασκήσεις από το dokey. Επίσης όσον αφορά το συμμετοχικό περιεγχόμενο, επέλεξα να κάνω το Α(δύο νέες εικόνες με λεζάντα και με ελεύθερα πνευματικά δικαιώματα ή που επιτρέπουν εμπορική χρήση) και το Γ( 1) μια νέα μελέτη περίπτωσης ή 2) μια νέα βιογραφία, ή 3) ένα νέο διάγραμμα). Στην ενδιάμεση αναφορά περιέγχονται οι 2 από τις ασκήσεις του dokey και το ερώτημα Α από το συμμετοχικό περιεγχόμενο. Στην τελική αναφορά περιέγχονται οι υπόλοιπες 4 και το ερώτημα Γ από το συμμετοχικό περιεγχόμενο όπου επέλεξα να γράψω τη σύντομη βιογραφία του Steve Jobs. Τα πάντα είναι εντός των προθεσμιών.
