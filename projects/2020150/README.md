...
Στην εισαγωγή ανάφερα πως θα ήθελα να ασχοληθώ με την σχεδίαση customizable συστημάτων και το Arch είναι ένα πολύ καλό παράδειγμα. Με όλη την εμπιρεία που είχα με αυτό, έχω μία καλή κατανόηση για την παραγωγή παρόμοιων εφαρμογών.
