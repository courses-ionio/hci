...
Ξεκινώντας με την εγκατάσταση αρχικά έψαξα στο επίσημο wiki, όπου βρήκα σχετικά αύκολα το link λήψης του αρχείου ISO, και μετά από σχετική έρευνα αποφάσησα να χρησιμοποιήσω ένα usb στικάκι λόγω της ευκολίας χρήσης του. Εκεί αντιμετώπισα και το πρώτο πρόβλημα καθώς η χρήση ενός μικρού usb μπορούσε να καταλήξει στην γρήγορη φθορά του οπότε μετά
