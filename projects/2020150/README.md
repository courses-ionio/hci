...
Η συνέχεια ήταν σχετικά ομαλή με την λήψη πακέτων file manager (pCmanFM) και window manager (i3), έστι ώστε να μπορέσω να χρησιμοποιήσω το σύστημα για την ολοκλήρωση της εργασίας χωρίς την χρήση windows. Έμαθα πώς να αλλάζω την φωτεινότητα της οθόνης και κατέβασα ένα πακέτω μέσω github για την καλύτερη χρήση του ήχου καθώς το built in πακέτο επέτρεπε πολύ υψηλή ένταση και δεν ήθελα να προκληθεί κάποια ζημιά στα ηχεία. Το μόνο άλτο πρόβλημα που ανιμετώπισα ήταν η αλλαγή γλώσσας στα ελληνικά με την μόνη λειτουργική λήση που βρήκα είναι η χρήση terminal.  

<br />

## **Προβλήματα με την εγκατάσταση και την προετοιμασία**
Αρχικά, υπήρξε ένα πρόβλημα με τον φορτιστή της συσκευής μου οπότε άργησα να ξεκινήσω την εργασία. Επίσης κατά την εγκατάσταση προέκυψε πρόβλημα με την σωστή επανεκκίνηση του συστήματος, την ένταση του ήχου αλλά και με τα drivers για το touchpad/touchscreen μετά την εγκατάσταση windows manager. Τα περισσοτερα έχουν επιλυθεί πλέων, έστω μερικώς, και δεν επηρεάζουν την χρήση του συστήματος.
