...
# `UPDATE`
  ...
  `Lego-Education-WeDo-2.0` όπου και οι δύο φωτογραφίες ανήκουν στον τομέα της εκπαιδευτικής τεχνολογίας. Η εκπαιδευτική τεχνολογία είναι ένας τομέας ο οποίος με ενδιαφέρει και όπως
...
Το Lego Education WeDo 2.0 είναι μια σειρά από κατασκευές με τουβλάκια της Lego και μηχανικά εξαρτήματα(γρανάζια, κινητήρες, αισθητήρες)απευθύνεται σε μικρότερο ηλικιακά κοινό από ότι άλλες σειρές της εταιρίας. Αποτελείται από μικρά τουβλάκια Lego και δίνεται στον χρήστη, η ευκαιρία να δημιουργήσει ότι εκείνος φανταστεί. Το ρομπότ δέχεται εντολές
