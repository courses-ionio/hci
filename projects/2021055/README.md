...
# `UPDATE`
  ...
  `Lego-Education-WeDo-2.0` όπου και οι δύο φωτογραφίες ανήκουν στον τομέα της εκπαιδευτικής τεχνολογίας. Η εκπαιδευτική τεχνολογία είναι ένας τομέας ο οποίος με ενδιαφέρει και έχω σκοπό να ασχοληθώ πιο εντατικά στο μέλλον επειδή, είναι αρκετά δύσκολο στην σημερινή εποχή όπου ένα παιδί έχει πρόσβαση σε άπειρες δραστηριότητες όπως τα βιντεοπαιχνίδια και εξαιτίας του παρωχημένου εκπαιδευτικού συστήματος, να ασχοληθεί με την μάθηση και να καταλάβει την αξία της από τόσο μικρή ηλικία, πόσο μάλλον μια συσκευή ή εφαρμογή να βοηθήσει σε αυτό.
  
## Σύντομη παρουσίαση του Lego-wedo 2.0

![317930116_675241460994637_2563588855792332871_n](https://user-images.githubusercontent.com/115211756/205500180-c49bc24f-4158-4e1b-ab6b-32088604c656.jpg)

Το Lego Education wedo 2.0 είναι μια σειρά με κατασκευές απο τουβλάκια της Lego η οποία απευθύνεται σε μικρότερο ηλικιακά κοινό από ότι άλλες σειρές της εταιρίας. Αποτελείται από μικρά τουβλάκια lego και δίνεται στον χρήστη, η ευκαιρία να δημιουργήσει ότι εκείνος φανταστεί. Τέλος, μέσα από ειδικό app της εταιρίας ή από άλλες γλώσσες προγραμματισμού(scratch) ο χρήστης μπορεί να δώσει εντολές στην κατασκευή στον τομέα των κινήσεων.
...
Σε αυτό το παραδοτέο έπρεπε να προσθέσουμε στα κεφάλαια του βιβλίου μια παράγραφο η οποία να συμπληρώνει το ήδη υπάρχον περιεχόμενο. Προσωπικά επέλεξα το κεφάλαιο 6 και συγκεκριμένα την υποενότητα 6.3 "Μέσο επικοινωνίας".Επέκτεινα την πρώτη παράγραφο η οποία, αναφέρεται στις εφαρμογές επικοινωνίας μεταξύ ανθρώπου - υπολογιστή, με τις διαδικτυακές εφαρμογές zoom και webex οι οποίες, έχουν καταφέρει σε πολλές περιπτώσεις να αντικαταστήσουν την ίδια την ανθρώπινη φυσική παρουσία.

## Η συνησφορά μου
![Η συνεισφορά μου](https://user-images.githubusercontent.com/115211756/205298042-c424db0f-2eb4-4780-9651-42c1f644cbb2.png)

## Το κεφαλαίο που ασχολήθηκα
![To κεφάλαιο που επέλεξα](https://user-images.githubusercontent.com/115211756/205297612-11b5fdb2-34dd-4d67-b213-a2abb007554d.png)


* link του βιβλίου σε μορφή pdf: [book.pdf](https://github.com/Axileaszervos/kallipos/issues/1)
* link απο το δικό μου φίλτρο: [App.lua](https://github.com/Axileaszervos/kallipos/blob/master/App.lua)
* link του περιεχομένου που πρόσθεσα: [App.md](https://github.com/Axileaszervos/kallipos/blob/master/APP/App.md)
