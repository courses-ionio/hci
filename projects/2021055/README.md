...
Τέλος, με το ps1 άλλαξα το όνομα μου, με το [neofetch](https://github.com/dylanaraps/neofetch) έδειξα πληροφορίες για το υπολογιστικό σύστημα μου και με την εντολή ls -a εμφάνισα τα dot files μου.
