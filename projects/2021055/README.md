...
Σε αυτό το παραδοτέο είχαμε να εξασκηθούμε με διάφορα [warm-ups](https://github.com/epidrome/dokey).Προσωπικά ασχολήθηκα και εκτέλεσα τρία απο τα διαθέσιμα που υπήρχαν. Αρχικά, 
Εγω εκτέλεσα τα:
