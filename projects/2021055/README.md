...
Το lego-wedo είναι μια σειρά η οποία απευθύνεται σε μικρότερο ηλικιακά κοινό από ότι άλλες κατασκευές της Lego. Αποτελείται από μικρά τουβλάκια lego και δίνεται στον χρήστη η ευκαιρία να δημιουργήσει ότι εκείνος φανταστεί. Τέλος, μέσα από ειδικό app της εταιρίας ή από άλλες γλώσσες
προγραμματισμού(scratch) ο χρήστης μπορεί να δώσει εντολές στο ρομπότ για τις κινήσεις του.
