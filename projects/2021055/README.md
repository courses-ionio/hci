...
![legowedo](https://user-images.githubusercontent.com/115211756/205501983-ce5f89ef-bbc5-4b80-9fbd-6471e38107b8.jpg)

Το Lego Education wedo 2.0 είναι μια σειρά με κατασκευές απο τουβλάκια της Lego στο τμημα Lego education η οποία απευθύνεται σε μικρότερο ηλικιακά κοινό από ότι άλλες σειρές της εταιρίας. Αποτελείται από μικρά τουβλάκια lego και δίνεται στον χρήστη, η ευκαιρία να δημιουργήσει ότι εκείνος φανταστεί. Παρέχεται η δυνατότητα προγραμματισμού του ρομποτ μέσω έτοιμου προγράμματος της Lego το οποίο περιέχει προγραμματισμο με χρηση μπλοκς σε πολυ απλη μορφη.
