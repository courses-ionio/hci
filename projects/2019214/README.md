...
Για πρώτη άσκηση γραμμής εντολών αποφάσισα να ασχοληθώ, πέρα απο την εγκατάσταση του Arch Linux, με μία απλή άσκηση warm-up οπού καλούμε το πακέτο `neofetch` (για να δούμε τις περαιτέρω πληροφορίες του λογισμικού και υλισμικού του συστήματος) και στην συνέχεια προβάλω τα directories και τα dot files με την βοήθεια της εντολή `ls`. 
