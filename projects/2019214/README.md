...
Η τρίτη άσκηση γραμμής εντολών που προτήμισα να κάνω, είναι από την λίστα hci όπου ζητάει να αναζητήσω, κατεβάσω το αγαπημένο τραγούδι του μήνα με το πακέτο `youtube-dl` και στην συνέχεια να παίξω το επιλεγμένο τραγούδι στο τερματικό με την βοήθεια του πακέτου `mpv`. 
