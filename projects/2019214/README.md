...
| 8 | [Συμμετοχικό περιεχόμενο 1Β](#συμμετοχικό-περιεχόμενο-1β)| Για συμμετοχικό περιεχόμενο 1Β, έκανα μελέτη περίπτωσης του Sony U-matic. <br /> <br /> Κάτι που συνδυάζει τις προηγούμενες θεματικές μου, και πιστεύω, ότι ήταν μία ταιριαστή επιλογή. |
...
| 12 | [Επίλογος - Αίτημα Ενσωμάτωσης](#επίλογος---αίτημα-ενσωμάτωσης) | Συγγραφή επιλόγου για τους στόχους που είχα στην αρχή του μαθήματος και μετά |
