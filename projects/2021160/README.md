...
| 12 | Τελική αναφορά* |[Συζήτηση](https://github.com/courses-ionio/help/discussions/2102#discussion-4759085)|Επιτυχής ολοκλήρωση του παραδοτέου|
...
Με αυτό το παραδοτέο η εργασία του μαθήματος Επικοινωνία Ανθρώπου-Υπολογιστή έχει ολοκληρωθεί. Η εμπειρία του μαθήματος έχει επεκτήνει τις γνώσεις μου σχετικά με το λογισμικό των Arch Linux και των εργαλίων που μας προσφέρει το github. Όμως λόγο προβλημάτων που προέκυψαν είτε με το github, είτε με το netlify δεν κατάφερα να ολοκληρώσω όλα τα παραδοτέα που ζητήθηκαν, για αυτόν το λόγο θα πρέπει να ευχαριστώ τους συναδέλφους μου στον ομαδικό οργανισμό που με βοήθησαν να τα αντιμετωπίσω, και να ολοκληρώσω την πλειονότητα των παραδοτέων.
