...
Σκοπός της τελευταίας άσκησης γραμμής εντολών ήταν να εξοικειωθώ με τις βασικές εντολές, την ανάγνωση τεκμηρίωσης και την επεξεργασία αρχείων μέσο terminal. Συγκεκριμένα εγώ επέλεξα το κομμάτι "error correction" το οποίο έχει την ευχέρεια να διορθώνει την προηγούμενη εντολή της κονσόλας.

#Συμπέρασμα

Με βάση τις διαλέξεις και τα εργαστήρια που είχα παρακολουθήσει όλο το εξάμηνο, κατάφερα να πραγματοποιήσω τους στόχους μου για το μάθημα Επικοινωνία Ανθρώπου - Υπολογιστή αφού κατανόησα το αντικείμενο μελέτης και πλέον η υλοποίηση του είναι πιο αποτελεσματική.
