...
Οι τίτλοι των παραδοτέων που υλοποιήθηκαν βρίσκονται στα περιεχόμενα, όλα τα παραδοτέα υλοποιήθηκαν πλήρως ή και με το παραπάνω και έγιναν commit έγκυρα συνήθως πολύ νωρίτερα από την ημερομηνία τους. Το μόνο παραδοτέο που υπήρξε ένα μικρό πρόβλημα είναι το παραδοτέο 6 (Συμμετοχικό Α1 και Α2) όπου λόγο προβλήματος με το update τον submodule τα αρχεία τα ανέβασα σε ένα custom repository και πρόσθεσα τα link προς αυτό για κατοχύρωση της προθεσμίας, όμως πλέον έλυσα το πρόβλημα και έχω αλλάξει τα links προς τα update submodule. <br />
<br />
Σε περίπτωση που έχουν πραγματοποιηθεί περεταίρω ενέργειες από αυτά που ζητάει η εκφώνηση της εργασίας αυτές περιγράφονται αναλυτικά  στην υποενότητα του αντίστοιχου παραδοτέου. Όσον αφορά τις δυσκολίες, πάντα υπήρχαν πολλές που έπαιρναν πάρα πολύ χρόνο για να λυθούν. Οι δυσκολίες των παραδοτέων δεν αναφέροντα σχολαστικά καθώς είναι πάρα πολλές και μακροσκελείς. Όμως τα link και η έρευνα που έχω κάνει πάνω σε κάθε παραδοτέο προδίδουν τυχόν παραπάνω προβλήματα από όσα αναφέρονται. <br />
<br />
