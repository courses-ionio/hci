...
###### Σημ: Το 2ο διάγραμμα χρησιμοποιεί script που ο Chromium αναγνωρίζει σαν "μη ασφαλες". Πρέπει να του επιτραπεί η λειτουργία για να εμφανιστεί. Στον Firefox παίζει κανονικά. 
