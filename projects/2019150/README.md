...
Οτάν για πρώτη φορά είδα το περιεχόμενο αυτού του μαθήματος στόχος μου έγινε να αποκομήσω όσες περισσότερες γνώσεις μπορώ. Πιο συγκεριμένα, να μάθω πως να χειρίζομαι το github με τον καλύτερο δυνατό τρόπο (από τα βασικά μέχρι και κάποιες λίγο πιο εξηδικευμένες γνώσεις), κάτι που τελικά για να παραδώσει κάποιος την τελική αναφορά οφείλει να πετύχει. Ακόμη, να γνωρίσω και να εξικοιωθώ με γλώσσες όπως η html και η css (στις ασκήσεις προγραμματισμού χρησιμοποίησα αυτές τις δύο). Τέλος να μάθω να χειρίζομαι το terminal του     λειτουργικού linux (ubuntu) ένα λειτουργικό που ο κάθες προγραμματιστής πρέπει να χειρήζεται με ευκολία και που σχεδόν όλλες οι διεργασίες πραγματοποιούνται μέσω του terminal του λειτουργικού. Από τις ασκήσεις προγραμματισμού γνώρισα κάποια βασικά commands στις css και html που θα μου φανούν αρκετά χρήσιμα, αφού τρς επεξεργασίας μίας εικόνας με σκοπό την προσαρμογή και την αφομιωσή της σε π.χ. μία ιστοσελίδα καθώς και την δημιουργεία διαφόρων 'effect' όταν για παράδειγμα ο χρήστης ακουμπάει το ποντίκι πάνω της. 
