...
Στο δεύτερο συμμετοχικό υλικό έγραψα να μία μελέτη περίπτωσης και μία βιογραφία για έναν από τους ανθρώπους που συνέφεραν στην δημιουργία αυτού του αντικειμένου. Έτσι έγραψα ένα κείμενο για το πώς έφτασε στο σημείο που είναι σήμερα η intel και μία σύντομη βιογραφία για τον Gordon Moore.
