...
Εισαγωγή: Από το μάθημα αυτό θα προσπαθήσω να πάρω όσες περοσσότερες πληροφορίες μπορώ, για την αξιοπολιηση τους σε περετέρω εξάμηνα-μαθήματα καθώς και στην μελλοντική μου καριέρα.
Για την επίτευξη αυτού του στόχου θα προσπαθήσω να είμαι παρών σε αν όχι όλα, σχεδόν όλα τα εργαστήρια, να κάνω όλες τις εργασίες που θα μας αναθέσετε στο επιτρεπόμενο
χρονικό όριοκαι να είμαι όσο περεσσότερο ενεργός μπορώ κατά την διάρκει αυτού του μαθήματος.
