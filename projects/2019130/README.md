# Σελίδα τελικής αναφοράς επικοινωνία ανθρώπου υπολογιστή
- Βασίλης Τσουκάλης
- ΑΜ:2019130
- Ομάδα: [Invicta-Ionian-Hci](https://github.com/Invicta-Ionian-Hci)
...
Με την ενασχόληση μου με το μάθημα πέρα από την απαραίτητη κατάρτιση με το Github και το λειτουργικό σύστημα των Linux, έχω και κάποιους άλλους στόχους που θέλω να κατακτήσω. Πρώτος από αυτούς είναι να εμβαθύνω και να επεκτείνω τις γνώσεις μου γύρω από την VR τεχνολογία, ένα αντικείμενο που με ενδιαφέρει αρκετά. Η προσέγγιση που θα ακολουθήσω θα δίνει βάση στη τεχνολογία από την σκοπιά της προσωπικής εμπειρίας και όχι στην τεχνολογία καθαυτή. Αυτή η προτίμηση προκύπτει από την έκπληξη που προκαλεί η έντονη επιρροή των VR συσκευών στην παγκόσμια κοινότητα, καθώς όλο και περισσότερες εταιρίες και ομάδες από developers στρέφονται στην ανάπτυξη εφαρμογών γύρω από αυτό το πεδίο. Ένα πολλά υποσχόμενο πεδίο κατά την γνώμη μου είναι η συνεργασία μέσω VR, καθώς με την τεχνολογία αυτή άτομα από όλο τον κόσμο μπορούν να βρεθούν στο ίδιο εικονικό περιβάλλον και να δουλέψουν πάνω στο ίδιο θέμα. Δεύτερος στόχος είναι η κατάκτηση των εργαλείων που προσφέρονται, όχι σε επίπεδο απλής χρήσης, αλλά σε βαθμό που θα μπορώ να αντιληφθώ τον τρόπο λειτουργίας έτσι να μπορώ να δημιουργήσω με αυτά όχι ένα απλό demo τις λειτουργιάς τους άλλα κάτι που να βοηθάει έμενα και να καλύπτει προσωπικές μου ανάγκες. Τρίτος και πιστεύω πιο δύσκολος στόχος είναι ο σωστός συντονισμός μιας ετερόκλητης ομάδας ανθρώπων και η συνεργασία μου με αυτήν για την επίτευξη του σκοπού μας. Τέλος με τα βίντεο κουΐζ έθεσα ως στόχο την αφομοίωση της κοσμοθεωρίας του ομιλητή ευελπιστώντας να καταλάβω τι εξυπηρετούν οι διάφοροι μηχανισμοί διάδρασης σαν ιδέα και όχι απλός την κατανόηση της λειτουργιάς κάποιου συγκεκριμένου μηχανισμού. Με αυτόν των τρόπο πιστεύω μπορώ να καταλάβω καλύτερα την έννοια της διάδρασης με τον υπολογιστή.
