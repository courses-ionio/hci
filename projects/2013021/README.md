...
| 3 |<sup><a href="#3"> Άσκηση γραμμής εντολών - Δεύτερη προσπάθεια εγκατάστασης του λειοτυργικού Arch Linux|
| 4 |<sup><a href="#4"> Συμμετοχικό περιεχόμενο 1A |
| 5 |<sup><a href="#5"> Άσκηση γραμμής εντολών - Εύρεση χαρακτηριστικών του συστήματος με τις εντολές journalctl και neofetch|
| 6 |<sup><a href="#6">συμμετοχικό περιεχόμενο 2A |
| 7 |<sup><a href="#7">Άσκηση γραμμής εντολών - Search, download and play (with the terminal) your favorite song|
...
| 11 |<sup><a href="#11">Άσκηση γραμμής εντολών - Organize your notes with emacs|
