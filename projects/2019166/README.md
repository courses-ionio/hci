...
Pull request :
 ...
 Στο κεφάλαιο 4 (Αρχέτυπα) στη σελίδα 58 του βιβλίου σας, αναλύετε την έννοια της πολυτροπικής διάδραδσης που βοηθάει στην επικοινωνία ανάμεσα στον άνθρωπο και στον υπολογιστή και δίνεται και κάποια παραδείγματα, όπως είναι το ποντικί που με την δόνηση του καταλαβαίνει ένας τυφλός που βρίσκεται στον υπολογιστή. Έτσι αποφάσισα να προσθέσω μία μικρή παράγραφο στην οποία θα αναλύω ακόμα δύο παραδείγματα για την πολυτροπική διάδραση, διότι μου φάνηκε αρκετά ενδιαφέρον. Αρχικά, αναφέρω ένα παράδειγμα για τα χειρουργία που έχουν μέσα μηχανήματα και οι γιατροί γνωρίζουν γρήγορα και σωστά την κατάσταση του ασθενή τους, το οποίο έχει βοηθήσει αρκετά στις μέρες μας. Το δεύτερο παράδειγμα, αναφέρεται στα φανάρια του δρόμου στα οποία υπάρχει μία συσκεύη η οποία εκπέμπει ήχο ώστε να καταλαβαίνει ο τυφλός αν το φανάρι είναι κόκκινο ή πράσινο για τους πεζούς.Τέλος, μετά από αυτή την έρευνα που έκανα συνειδητοποίησα πως η πολυτροπική διάδραση έχει βοηθήσει σε πολλά πράγματα στην καθημερηνότητα μας.
 

 
Το screenshot της προσθήκης μου :

 ![picture](https://user-images.githubusercontent.com/72515404/205616198-7606feb3-2b87-42ea-943a-59d3e068b626.png)

My links:
 
 - [link βιβλίου σε μορφή pdf στο github](https://github.com/olumpiaalexopoulou/kallipos/blob/master/book/book.pdf)
 - [link του .lua αρχείου μου](https://github.com/olumpiaalexopoulou/kallipos/blob/master/multimodal.lua)
 - [link του .md αρχείου μου](https://github.com/olumpiaalexopoulou/kallipos/blob/master/2019166/multimodal.md)
 - [link του make-latex.sh](https://github.com/olumpiaalexopoulou/kallipos/blob/master/make-latex.sh)
 - [link του screenshot μου](https://github.com/olumpiaalexopoulou/kallipos/blob/master/mypictures/picture.png)
