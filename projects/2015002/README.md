...
#### Shell Scripts Repository: [Scripts](https://github.com/mariosconsta/shell-scripting)
...
| 2 | [Άσκηση γραμμής εντολών](#2ο-παραδοτέο---εγκατάσταση-arch-linux-σε-usbid2)|Πλήρης **ολοκλήρωση, μετά από τεχνικά προβλήματα** |
...
| 7 | [Άσκηση γραμμής εντολών](#7ο-παραδοτέο---download-mp3) | Πλήρης **ολοκλήρωση** - [Script](https://github.com/mariosconsta/shell-scripting/blob/main/Scripts/youtube.sh) |
...
| 11 |[Άσκηση γραμμής εντολών](#11ο-παραδοτέο---άσκηση-γραμμής-εντολών) | Πλήρης **ολοκλήρωση** - [Script](https://github.com/mariosconsta/shell-scripting/blob/main/Scripts/tmux.sh) |
...
Παράλληλα έχω εξοικειωθεί με το GitHub. Λάτρεψα την πλατφόρμα για την επικοινωνία και λειτουργικότητα που προσφέρει σε προγραμματιστές και δημιουργούς. Την χρησιμοποιώ σε προσωπικό επίπεδο για δικά μου project, όπως ένα [Chat Bot](https://github.com/mariosconsta/chatbot) που φτιάχνω σε γλώσσα προγραμματισμού Python! Work in progress!!
...
#### Μπορείτε να δείτε τα Script σε αυτό το [Repository](https://github.com/mariosconsta/shell-scripting):

Η πιο αναλυτικά στο παρακάτω πίνακα:

| Script | Link |
| --- | --- |
| calendar.sh | [link](https://github.com/mariosconsta/shell-scripting/blob/main/Scripts/calendar.sh) |
| specs.sh | [link](https://github.com/mariosconsta/shell-scripting/blob/main/Scripts/specs.sh) |
| tmux.sh | [link](https://github.com/mariosconsta/shell-scripting/blob/main/Scripts/tmux.sh) |
...
| Εγκατάσταση το Arch Linux με Virtualbox; #1616 | [link](https://github.com/courses-ionio/hci/discussions/1616)|
