...
Έχω αλλάξει το .vimrc αρχείο και το προσάρμωσα για την χρήση συγγραφής κώδικα python με τα εξής στοιχεια : 
Με την χρήση του packet manager Vundle για το vim προσθεσα το plugin jedi-vim το οποίο προσθέτη λειτουργικότητες σύγχρονων επεξεργαστών κειμένου όπως είναι η αυτόματη συμπλήρωση κςιμένου ή η αναγνώριση συντακτικών λαθών
Πρόσθεσα χρωματισμό σύνταξης για γλώσσες προγραμματισμού
Έκανα την περιήγηση μέσα στο κείμενο γρηγορότερη 
Πρόσθεσα την αρίθμηση γραμμών
Έκανα το statusline να αναφέρει την μορφή του αρχείου, τον τύπο εργασίας του vim, το σημείο στο οποίο βρίσκετε ο κέρσορας, την ημερομηνία και την ώρα του συστήματος
Τέλος, έκανα την αναζήτηση στο αρχείο να μην είναι case-sensitive.
