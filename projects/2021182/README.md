...
| 12 | Τελική αναφορά* | https://github.com/courses-ionio/help/discussions/2020 | 70% (Σίγουρα υπάρχει χώρος για βελτιώσεις και εξελίξεις, αλλά με γνώμονα τη απειρία και τις ατελείωτες ώρες που μαζί με την ομάδα αφιερώσαμε στα παραδοτέα μας, είμαι ικανοποιημένος από το τελικό αποτέλεσμα) |
