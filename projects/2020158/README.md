...
Δεν κατάφερα να ολοκληρώσω όλα τα παραδοτέα, αλλά έκανα μια προσπάθεια σε όλα τους. Κυριώς αντιμετώπισα πολλά προβλήματα με την χρήση του Arch και τις ασκήσεις γραμμών εντολών. Όμως, εξοικειώθηκα με την χρήση του Github και του Netlify. Επίσης, καθ'όλη την διάρκεια είχα καλή επικοινωνία με την ομάδα μου και βοηθήσαμε ο ένας τον άλλον πολλές φορές. 
