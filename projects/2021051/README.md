...
# 2ο ΠΑΡΑΔΟΤΕΟ
  ...
  στην σελίδα
  παρόλο που είναι στον σωστό φάκελο και το όνομα της είναι σωστό στο .md αρχείο που την αναφέρει. Από την παράδοση αυτού του παραδοτέου προσπαθώ να λύσω
  αυτό το
  ...
  # 6ο ΠΑΡΑΔΟΤΕΟ
  Σε αυτό το παραδοτέο έγραψα μια μικρή παράγραφο για το παιχνίδι pacman και την διάδραση ,άλλα αντι να εμφανίζεται στο pdf στην θέση του υπάρχει απλα η
  λέξη "image".
