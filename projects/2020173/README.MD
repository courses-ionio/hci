...
## Το ζητούμενο της δεύτερης εβδομάδας ήταν η εγκατάσταση των arch linux σε bootablε USB αλλά και την εκτέλεση και καταγραφή της δοκιμής εκτέλεσης των εντολών [neofetch](https://asciinema.org/a/VsOFcpWNWUt54R16kpyKyTwk6) και [journalctl -b](https://asciinema.org/a/EGfsyzFSEkoDzkC3lrW39xaRo) μέσο το asciimena
