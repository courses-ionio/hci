...
| Παραδοτέο 3      | https://github.com/courses-ionio/help/discussions/1476.    | Στο τρίτο παραδοτέο του μαθήματος μας ζητήθηκε να προσθέσουμε στο site του μαθήματος δύο εικόνες μαζί με μια περιγραφή σχετικά για τις εικόνες, εγώ πρόσθεσα το Pubtech, Norton Desktop που αποτελούν shell που έχουν αρκετά διαδραστικά στοιχεία με ένα Macintosh σύστημα παρόλο που είναι Windows shell κάνοντας έτσι τον χρήστη να αλλάξει τον τρόπο διάδρασης στις προσωπικές του ανάγκες όπως είχα θέσει σαν στόχο στην εγγραφή της εισαγωγής.|
| Παραδοτέο 4 | https://github.com/courses-ionio/help/discussions/1309.  | Στο τέταρτο παραδοτέο μας ζητήθηκε να κάνουμε μία άσκηση γραμμής εντολών, εγώ πρόβαλα τον καιρο στο συστημά μου χρησιμοποιώντας απλά μια εντολή και πάλι χρησιμοποιώντας απλά μία εντολή κατέβασα ένα αρχείο mp4 στο σύστημα μου με ιδιαίτερα γρήγορη ταχύτητα αφού χρησιμοποιήσα απλά μια εντολή που έγγραψα στο τερματικό, διαφορετικά θα έπρεπε ίσως να ανοίξω κάποιον browser και να μπω σε μια ίσως πιο χρονοβόρα διαδικασία. |
...
## Παραδοτέο 12
Μέσω των ασκήσεων του μαθήματος επικοινωνία ανθρώπου υπολογιστή αποκτήθηκαν γνώσεις όπως είναι πως το σύστημα διαχειρίζεται τα αρχεία και πόσο εύκολα μπορούμε μέσω εντολών να αλλάξουμε τον τύπο των αρχείων και να δουλέψουμε project τα οποία περιλαμβάνουν πολλούς τύπους αρχείων και ειδικά στο 6ο παραδοτέο. Επιπλέον μέσω τον ασκήσεων αυτών και τις σωστής καθοδήγησης από τον διδάσκοντα έγινε μελέτη για την σπουδαιότητα τον GUI αλλά και την διαφορά που έχει ένα επιτυχημένο GUI από ένα όχι και τόσο. Επιπρόσθετα από το βιβλίο του μαθήματος αποκτήθηκαν γνώσεις που αποφέρουν λύσεις σε αρκετά προβλήματα που ανακύπτουν κατα την δημιουργία γραφικών διεπαφών όπως είναι πως οι χρήστες θα πρέπει να συμμετέχουν ενεργά στην κατασκευή αυτών τον διεπαφών για την επιτυχία τους. Επιπλέον μέσω τον εβδομαδιαίων βίντεο κουιζ κατάφερα να παρατηρήσω και να μπω στον τρόπο σκέψης πατέρων της πληροφορικής όπως ο Alan Kay, Ted Nelson κτλ, να μάθω τα πλεονεκτήματα και τα μειωνεκτήματα ενός συστήματος με modes, να μάθω πως οι συσκευές μπορούνε να επηρεάσουν τον τρόπο διάδρασης του ανθρώπου με τα συστήματα (π.χ ποντίκι, oculus rift κτλ) και τέλος κατάφερα να μάθω έναν τρόπο ώστε χρησιμοποιώντας την Bash, δηλαδή εντολές shell να επιταγχύνω και να αυτοματοποιήσω κάποιες διαδικασίες που διαφορετικά θα ήταν πιο δαπανειρό χρονικά με διαφορετικό τρόπο. (Όπως είδαμε και στο παράδειγμα 6, άσκησεις γραμμής εντολών) 
