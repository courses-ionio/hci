...
| 2 | [Άσκηση γραμμής εντολών(linux install on HW)](#2ο-παραδοτέο) | | |
...
Η κύρια πηγή αναφοράς μου καθ'όλη την διάρκεια της εγκατάστασης ηταν τα [arch linux wiki](://wiki.archlinux.org/title/installation_guide). 
