...
| --- | --- | --- | --- | --- |
| 1 | Eισαγωγή : <sup><a href="#1">Προσωπικοί στόχοι </a></sup> | Εγκαίρως | Ολοκληρωμένο | Όχι |
...
| 12 | Συμπεράσματα : <sup><a href="#12">Σύγκριση στόχων-αποτελεσμάτων </a></sup> | Εγκαίρως | Ολοκληρωμένο | Όχι |
...
Τελιώνωντας αυτή την εμπειρία των 12 εβδομάδων διαθέτω γνώσεις που δεν μπορούσα να φανταστώ γράφοντας την είσαγωγη στην 1η εβδομάδα.Αρχικά,εξελίχθηκα στην πλατφορμα του github οχι μόνο για την εργάσια μου αλλα και σαν pro member εκμεταλλεύτηκα όλες τις δυνατότητες που μας παρέχονται και το έχω συνδεσει με πολλές εφαργμογές για επιπλέον δωρεάν λογισμικό.Με βοήθησε να μάθω ενα τρόπο να φτιάξω ενα site,αυτή την φορά πάνω στο pibook,αλλά γνωρίζοντας την τεχνική ειναι εύκολο να επεκταθώ και τέλος μέσω των submodule έμαθα να χειρίζομαι το github repository μου μέσω ενώς αλλου εφεδρικού χωρίς να πειράζω το αρχικό,και να το κάνω Update μόλις η δουλειά ειναι ολοκληρομένη.Όσο αναφορά τις ασκήσεις προγραμαματισμού δεν είχα κάποιο πρόβλημα και τις έκανα σχετικά εύκολα αλλα έμαθα διαφόρα site και εφαρμογές που μπορούν να μου φανούν χρήσιμα στο μέλον όπως το codepen τo stackoverflow και άλλα.Η μεγαλήτερη γνώση που έλαβα απο το μάθημα είναι πάνω στο terminal και τα στις γραμμές εντολών γιατί ήταν η πρώτη μου επαφή με κάτι τέτοιο.Στην εισαγωγή χαρακτηρίζω το terminal αφιλόξενο αλλά πλέον μετά την εξοικείωση που μου χάρισε το μάθημα αλλά και την προσωπική μου μέλετη και επιμονή στις ασκήσεις έχω αλλάξει γνώμη.Η γενική μορφή του μαθήματος με έκανε να καταλάβω αυτο που είχα "προβλέψει" και στην εισαγωγή,οτι το πλάνο του μαθήματος(με τα παραδοτέα,την τελική αναφορά,τις πολλές οδηγίες και την απαλλαγή απο τις εξετάσεις) είναι μια μικρογραφία ενώς επαγγελματικου περιβάλλοντος.Τέλος, οτι η τελική αναφορά μου είναι κάτι καλύτερο απο αύτο που είχα στο νου μου την πρώτη εβδομάδα άρα θεωρώ οτι ξεπέρασα τους στόχους και τις ανάγκες μου!
