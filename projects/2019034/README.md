...
Σαν κύριες προσδοκίες από το μάθημα έχω, να μπορώ όλες τις πληροφορίες και γνώσεις που θα μου παρέχουν καθ'όλη την διάρκεια του μαθήματος οι καθηγητές, να τις χρησιμοποιήσω στις ασκήσεις του μαθήματος αλλά και στο όποιο μελλοντικό μου επάγγελμα. Επιπλέον, στοχεύω να εξοικειωθώ με την πλατφόρμα του GitHub όπως και άλλων που θα χρησιμοποιηθούν. Σαν στόχους όσον αφορά τις εργασίες που θα καλούμαστε να εκτελέσουμε, έχω την εξοικείωσή μου με την χρήση του τερματικού με σκοπό να μάθω κάθε δυνατή λειτουργία του και την έγκαιρη παράδοσή των εργασιών πριν την λήξη της προθεσμίας τους. Ωστόσο, αν τυχόν κάνω λάθος σε όποια από τις εργασίες, θα επιθυμούσα να μάθω την σωστή μορφή της.
...
<p>Στο πρώτο συμμετοχικό περιεχόμενο αποφάσισα να ασχοληθώ με τον πρώτο εκτυπωτή (1811, Γουτεμβέργιος) και έναν από τους πιο πρόσφατους (2020, Epson). Αρχικά, δημιούργησα τα submodules που χρειάζονται για την άσκηση ακολουθώντας τις οδηγίες. Ύστερα, πρόσθεσα τις δύο φωτογραφίες των εκτυπωτών στον φάκελο "images" και έκανα μία περιγραφή αυτών στον φάκελο "gallery". Μετά, δημιούργησα στα Slides μία νέα κατηγορία σχετική με τα περιφερειακά υπολογιστών όπου εκεί πρόσθεσα τους δύο εκτυπωτές. Τέλος, στο timeline και συγκεκριμένα στο "computer.md" εισήγαγα ξανά, τους δύο εκτυπωτές.
...
<p>Στην δεύτερη και τελευταία άσκηση συμμετοχικού περιεχομένου, πρόσθεσα δύο νέες εικόνες στο δικό μου submodule. Η πρώτη αφορούσε τον πρώτο εκτυπωτή και συγκεκριμένα το χαρτί αφού είχε εμφανιστεί πάνω του ότι έπρεπε να εκτυπωθεί. Περαιτέρω, με την συμπερίληψη της πρώτης εικόνας, έκανα μια νέα μελέτη περίπτωσης στον φάκελο Case Study. Σε αυτή μίλησα για την συνεισφορά του εκτυπωτικού πιεστηρίου στον κόσμο. Η δεύτερη εικόνα, αφορούσε μια εικόνα του προσώπου του Ιωάννη Γουτεμβέργιου. Ύστερα, με την συμπερίληψη της εικόνας αυτής έγραψα μια σύντομη βιογραφία για τον ίδιο και τα επιτεύγματα του.
...
Ύστερα από πολλή δουλειά, κατάφερα να φτάσω στο τελευταίο παραδοτέο, νιώθοντας ότι κάθε προσδοκία και στόχος μου από και για το μάθημα εκπληρώθηκε. Εκτός αυτού όμως, δημιουργήθηκαν περισσότεροι στόχοι για έμενα κατά την διάρκεια του εξαμήνου.  
<br><br>Χάρη στις εβδομαδιαίες ασκήσεις προγραμματισμού και γραμμής εντολών πλέον νιώθω ότι έχω αναπτύξει μεγάλες δεξιότητες πάνω στην δημιουργία προγραμμάτων σε διάφορες γλώσσες, αλλά προπάντων την χρήση του τερματικού. Αντίστοιχα, νιώθω πολύ εξοικειωμένος με την χρήση του GitHub, μια σπουδαία για εμάς του προγραμματιστές πλατφόρμα που ο καθηγητής του μαθήματος μας γνώρισε, μαζί με άλλες χρήσιμες πλατφόρμες (π.χ. το Codepen για την υλοποίηση ασκήσεων προγραμματισμού) και εργαλεία που χρησιμοποιήσαμε (π.χ. το Asciinema για την εγγραφή ασκήσεων γραμμής εντολών στο terminal) και θα συναντήσουμε στο μέλλον είτε στο πανεπιστήμιο, είτε σε δική μας προσωπική χρήση ή επάγγελμα. Επιπροσθέτως, έμαθα να κάνω πιο ακριβή αναζήτηση στο διαδίκτυο για να βρω την απάντηση που έψαχνα ώστε να βοηθηθώ με τις απορίες που είχα όταν “κολλούσα” στις ασκήσεις. Επομένως, οι στόχοι μου πάνω στο μάθημα ολοκληρώθηκαν επιτυχώς και πάνω απ’ όλα νιώθω πιο ικανός.
<br><br>Αξιοσημείωτο το γεγονός ότι δημιουργήθηκαν περισσότεροι στόχοι, κυρίως προσωπικοί, κατά την διάρκεια του εξαμήνου. Ενας σημαντικός στόχος για μένα πλέον είναι η μεγαλύτερη εξοικείωση μου με το τερματικό και η άριστη χρήση του, καθώς αποτελεί απαραίτητο εργαλείο ενός προγραμματιστή. Επίσης, θέλω να ενισχύσω τις γνώσεις μου πάνω στις γλώσσες HTML, CSS και JS που χρησιμοποιήσαμε σε όλες τις ασκήσεις προγραμματισμού. Επιπλέον, θέλω να μάθω να χρησιμοποιώ το GitHub καλύτερα, διότι είναι το Facebook των προγραμματιστών και θα μου φανεί πολύ χρήσιμο σε μελλοντικά projects, ατομικά ή μη.
<br><br>Η αλήθεια είναι ότι δυσκολεύτηκα με τις ασκήσεις γραμμής εντολών, καθώς πρώτη φορά δούλευα στο τερματικό του υπολογιστή μου και ένιωθα ανίκανος τον πρώτο καιρό με την ολοκλήρωση των ασκήσεων. Οι ασκήσεις προγραμματισμού ήταν πιο εύκολες, όλες είχαν πολύ ενδιαφέρον και το γεγονός ότι βλέπαμε σε εικόνα το αν κάναμε κάτι σωστά ή λάθος ήταν αυτό που τις καθιστούσε ιδιαίτερες για μένα. Το συμμετοχικό περιεχόμενο ήταν κάτι διαφορετικό σε σχέση με τις παραπάνω ασκήσεις καθώς περιλάμβανε έρευνα και προσθήκη υλικού. Τα βίντεο κουίζ και τα κουίζ ερωτήσεων στις διαλέξεις, ήταν επίσης πολύ ωραίες τεχνικές διδασκαλίας.
<br><br>Τέλος, παρά το ότι λίγες εργασίες μου ήταν εκπρόθεσμες, νιώθω πολύ ευχαριστημένος που δούλεψα σκληρά για κάθε μία από αυτές και κατάφερα να εκπληρώσω τον σκοπό τους και όλους τους στόχους μου.
