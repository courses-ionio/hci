...
<p>Η άσκηση που επέλεξα είχε να κάνει με την αναζήτηση και το άνοιγμα αρχείων του υπολογιστή μου, μέσω του terminal. Εγώ επέλεξα να ανοίξει και να εμφανίσει το περιεχόμενο δύο αρχείων .txt που είχα αποθηκευμένα σε έναν φάκελο. Για να ολοκληρώσω την άσκηση, αναζήτησα στο ίντερνετ για βοήθεια με τις εντολές που χρειαζόντουσαν για την υλοποίηση των ζητουμένων δηλαδή την αναζήτηση και άνοιγμα αρχείων.
