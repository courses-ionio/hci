...
| 10 |<li><a href="#Download MP3"><span class="toctext">Download MP3</span></a>|
...
Σαν κύριες προσδοκίες από αυτό το μάθημα έχω, να λάβω όλες τις πληροφορίες και γνώσεις που θα μου παρέχουν καθ'όλη την διάρκεια του μαθήματος οι καθηγητές, να μπορώ στην συνέχεια να τις χρησιμοποιήσω στις εβδομαδιαίες ασκήσεις του μαθήματος αλλά και γενικά στο όποιο μελλοντικό μου επάγγελμα. Επιπλέον, στοχεύω να εξοικιωθώ με την πλατφόρμα του GitHub όπως και άλλων που θα χρησιμοποιηθούν, που στο παρελθόν δεν είχα ξαναχρησιμοποιήσει. Σαν στόχους όσο αφορά τις εργασίες που θα καλούμαστε να εκτελέσουμε, έχω την εξοικείωσή μου με την χρήση του terminal με σκοπό να μάθω κάθε δυνατή λειτουργία του, την έγκερη παράδοσή των εργασιών πριν την λήξη της προθεσμίας αλλά και την σωστή επίλυσή τους. Ωστόσο, αν τυχόν κάνω λάθος σε όποια από τις εργασίες, θα επιθυμούσα να μάθω την σωστή μορφή της, όπως φαντάζομαι και ότι θα γίνει.



<br><br>
<h2><span id="Image Processing">(2) Image Processing (Άσκηση Προγραμματισμού)</span></h2>
<p>Η άσκηση που επέλεξα είχε να κάνει με την επεξεργασία των φίλτρων μίας εικόνας, συνδυασμό αυτών και ρύθμιση φωτεινότητας, αντίθεσης κλπ. Δημιούργησα τρία παραδείγματα της εικόνας με φίλτρα, το καθένα με διαφορετικά χαρακτηριστικά για να παρατηρήσει κανείς πόσο μπορεί να αλλάξει η μορφή μίας εικόνας με λίγες γραμμές εντολών. Υλοποιήθηκε σε HTML και CSS και χρησιμοποίησα τα σχόλια που υπήρχαν στο τμήμα της CSS για την προσθήκη νέων φίλτρων στην εικόνα. Για πρώτη άσκηση με δυσκόλεψε λίγο, αλλά κατάφερα να την εκτελέσω και να ολοκληρώσω το ζητούμενο και κατάφερα να αποκτήσω μία εμπειρία στην ανάπτυξη κώδικα σε CSS. Η άσκηση έγινε στο CodeOpen και βασίστηκα στις οδηγίες του καθηγητή σχετικά με τις ασκήσεις προγραμματισμού.
...
<p>Η άσκηση που επέλεξα είχε να κάνει με την αναζήτηση και το άνοιγμα αρχείων του υπολογιστή μου, μέσω του terminal. Εγώ επέλεξα να ανοίξει και να εμφανίσει το περιεχόμενο δύο αρχείων .txt που είχα αποθηκευμένα σε έναν φάκελο. Για να ολοκληρώσω την άσκηση, αναζήτησα στο ίντερνετ για βοήθεια με τις εντολές που χρειαζόντουσαν για την υλοποίηση των ζητουμένων δηλαδή την αναζήτηση και άνοιγμα αρχείων. Χρησιμοποίησα το Asciinema για να κάνω εγγραφή την κάθε κίνησή μου στο terminal, αφού πρώτα το εγκατέστησα και βασίστηκα στις οδηγίες του καθηγητή για τις ασκήσεις γραμμής εντολών.
...
<p>Η άσκηση που επέλεξα είχε να κάνει με την προσθήκη φίλτρων σε μια εικόνα, από την οποία όταν περνούσε από πάνω το ποντίκι, γινόταν μεγένθυση αυτής. Πάλι δημιούργησα τρία παραδείγματα φίλτρων πάνω στην εικόνα όπου τα δύο είναι σε σχόλια ώστε κάθε φορά να σβήνονται από το ένα και να προσθέτονται στο άλλο. Υλοποιήθηκε σε HTML και CSS και αξιοποίησα τα φίλτρα που δίνονταν στην άσκηση Image Processing ώστε να πετύχω τον σκοπό της άσκησης. Με βάση την προηγούμενη άσκηση, μπόρεσα να ολοκληρώσω αυτή πιο εύκολα αφού συνδεόντουσαν κυρίως στο κομμάτι εφαρμογής φίλτρων πάνω στην εικόνα. Η άσκηση έγινε στο CodeOpen και βασίστηκα στις οδηγίες του καθηγητή σχετικά με τις ασκήσεις προγραμματισμού.
...
<p>Η δεύτερη άσκηση γραμμής εντολών που υλοποίησα είχε να κάνει με τον έλεγχο του καιρού σε όποια περιοχή επιθυμούσα. Συγκεκριμένα, μονάχα με την εντολή "curl wttr.in/τοποθεσία" (χωρίς τα εισαγωγικά) στο terminal πράγματι μπόρεσα και κατάφερα να δω τον καιρό για την Κέρκυρα. Βέβαια όχι την δική μας, καθώς μου έδινε τον καιρό του χωριού με όνομα Corfu στην Αμερική. Ωστόσο, το θέμα είναι ότι έπιασα το νόημα της άσκησης και μπόρεσα να κατανοήσω τον τρόπο λειτουργίας της εντολής αυτής. Χρησιμοποίησα το Asciinema για να κάνω εγγραφή την κάθε κίνησή μου στο terminal και βασίστηκα στις οδηγίες του καθηγητή για τις ασκήσεις γραμμής εντολών. Τέλος, για την εύρεση των εντολών αξιοποίησα το λίνκ που έδωσε ο καθηγητής αλλά επίσης έκανα αναζήτηση στο διαδίκτυο για την εύρεση αυτών.
...
<br> <a href="https://github.com/chubin/wttr.in">Βοήθεια καθηγητή για την άσκηση.</a>
<br> <a href="https://github.com/epidrome/dokey">Λίστα με τις ασκήσεις γραμμής εντολών.</a></ul>
...
<p>Στο πρώτο συμμετοχικό περιεχόμενο αποφάσισα να ασχοληθώ με τον πρώτο εκτυπωτή (1811, Γουτεμβέργιος) και έναν από τους πιο πρόσφατους (2020, Epson). Αρχικά, δημιούργησα τα submodules που χρειάζονται για την άσκηση (images και gallery) ακολουθώντας πάντα τις οδηγίες του καθηγητή. Ύστερα, πρόσθεσα τις δύο φωτογραφίες των εκτυπωτών στον φάκελο "images" και αργότερα έκανα μία περιγραφή αυτών στον φάκελο "gallery". Μετά, δημιούργησα στα Slides μία νέα κατηγορία σχετική με τα περιφερειακά υπολογιστών όπου και εκεί πρόσθεσα τους δύο εκτυπωτές καθώς εκεί ανήκουν. Τέλος, στο timeline και συγκεκριμένα στο "computer.md" εισήγαγα ξανά, τους δύο εκτυπωτές με τους οποίους ασχολήθηκα. Για την ολοκλήρωση της άσκησης, βασίστηκα εξ ολοκλήρου στις οδηγίες του καθηγητή.
...
<br> <a href="https://en.wikipedia.org/wiki/File:Handtiegelpresse_von_1811.jpg">Φωτογραφία που χρησιμοποίησα για τον πρώτο εκτυπωτή.</a>
<br> <a href="https://www.techradar.com/best/best-epson-printers">Φωτογραφία που χρησιμοποίησα για τον νέο εκτυπωτή της Epson (πρώτη εικόνα).</a>
...
<p>Η άσκηση που επέλεξα να κάνω, περιλάμβανε έναν διαδραστικό κώδικα που χρησιμοποιούσε το ποντίκι ως συσκευή εισόδου για τη συμπλήρωση μίας φόρμας και έδινε ως έξοδο το ανάλογο αποτέλεσμα στην οθόνη. Συγκεκριμένα, η φόρμα ζητούσε από τον χρήστη να συμπληρώσει την ημερομηνία γέννησής του και εγώ έπρεπε να προσθέσω στην φόρμα την δυνατότητα συμπλήρωσης του φύλου του χρήστη (Male ή Female). Για να το πετύχω αυτό, αντέγραψα το κομμάτι του κώδικα στην HTML που αφορούσε την συμπλήρωση ημερομηνίας γέννησης, και το έκανα επικόλληση ακριβώς από κάτω του ώστε να το επεξεργαστώ ανάλογα προκειμένου να πετύχω τον σκοπό της άσκησης. Η άσκηση μου φάνηκε πιο εύκολη, καθώς νιώθω πλέον πιο εξοικειωμένος με τις ασκήσεις προγραμματισμού. Η άσκηση έγινε στο CodeOpen και βασίστηκα στις οδηγίες του καθηγητή σχετικά με τις ασκήσεις προγραμματισμού.
...
<p>Η τελευταία άσκηση γραμμής εντολών που επέλεξα να κάνω, είχε να κάνει με την εγκατάσταση αρχείου .mp3 από το youtube downloader στο terminal. Αρχικά, έπρεπε να κατεβάσω το ίδιο το Youtube Downloader στο terminal, κάτι που κατάφερα με την χρήση της εντολής "sudo wget *link YD* -O /usr/local/bin/youtube-dl" και "sudo chmod a+rx /usr/local/bin/youtube-dl" (χωρις τα εισαγωγικά βέβαια). Μετά την ολοκλήρωση αυτής της διαδικασίας, με την εντολή "youtube-dl -x--audio-format mp3 *link of the song*" κατεβάζουμε το τραγούδι που επιθυμούμε. Επιπλέον, ωστέ να παίξει το κομμάτι, έπρεπε ύστερα να κατεβάσω ένα audio player με την εντολή "sudo apt-get install sox libsox-fmt-all" και για να παίξει το κομμάτι χρησιμοποίησα την εντολή "play 'name of the song' ". Ωστόσο, για κάποιο λόγο που δεν κατάλαβα, το τραγούδι δεν έπαιζε (σε όσα και να το δοκίμασα). Χρησιμοποίησα το Asciinema για να κάνω εγγραφή την κάθε κίνησή μου στο terminal και βασίστηκα στις οδηγίες του καθηγητή για τις ασκήσεις γραμμής εντολών.
  
<a href="https://asciinema.org/a/383611">Download MP3</a>
<h6>Βιβλιογραφία που χρησιμοποίησα:</h6>
<ul> <a href="https://asciinema.org/">Asciinema.</a>
<br> <a href="https://courses-ionio.github.io/projects/dokey/">Οδηγίες μαθήματος για τις ασκήσεις γραμμής εντολών.</a>
<br> <a href="https://github.com/ytdl-org/youtube-dl">Βοήθεια από καθηγητή για την εγκατάσταση και χρήση του Youtube Downloader.</a>
<br> <a href="https://github.com/mpv-player/mpv">Βοήθεια από καθηγητή για την εγκατάσταση και χρήση του Music Player.</a>
<br> <a href="https://github.com/epidrome/dokey">Λίστα με τις ασκήσεις γραμμής εντολών.</a></ul>
...
<p>Στην δεύτερη και τελευταία άσκηση συμμετοχικού περιεχομένου, πρόσθεσα δύο νέες εικόνες στο δικό μου submodule του images. Η πρώτη αφορούσε τον πρώτο εκτυπωτή και συγκεκριμένα το χαρτί αφού είχε εμφανιστεί πάνω του ότι έπρεπε να εκτυπωθεί. Περαιτέρω, με την συμπερίληψη της πρώτης εικόνας, έκανα μια νέα μελέτη περίπτωσης που πρόσθεσα στον φάκελο Case Study. Σε αυτή μίλησα για την συνεισφορά του εκτυπωτικού πιεστιρίου στον κόσμο. Η δεύτερη εικόνα, αφορούσε τον Ιωάννη Γουτεμβέργιο και πιο συγκεκριμένα μια εικόνα του προσώπου του. Ύστερα, με την συμπερίληψη της εικόνας αυτής έγραψα μια σύντομη βιογραφία για τον ίδιο και τα επιτεύγματα του. Για την ολοκλήρωση της άσκησης, βασίστηκα στις οδηγίες του καθηγητή.
