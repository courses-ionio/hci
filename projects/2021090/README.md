...
#### Προφίλ Github: [kafter](https://github.com/inf2021090)

#### Προφίλ Github Ομάδας: [ContattoContare](https://github.com/ContattoContare)
...
| --- | --- | --- | --- |
| 1 | [Εισαγωγή](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CF%80%CF%81%CF%8E%CF%84%CE%B7---%CE%B5%CE%B9%CF%83%CE%B1%CE%B3%CF%89%CE%B3%CE%AE)| [Click](https://github.com/courses-ionio/help/discussions/976) | Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br>|
| 2 | [Άσκηση γραμμής εντολών (linux install)](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CE%B4%CE%B5%CF%8D%CF%84%CE%B5%CF%81%CE%B7---%CE%AC%CF%83%CE%BA%CE%B7%CF%83%CE%B7-%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%AE%CF%82-%CE%B5%CE%BD%CF%84%CE%BF%CE%BB%CF%8E%CE%BD-linux-install) |[Click](https://github.com/courses-ionio/help/discussions/1112) |Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br> Εγκατάσταση σε πραγματικό HW  |
| 3 | [Συμμετοχικό περιεχόμενο A1](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CF%84%CF%81%CE%AF%CF%84%CE%B7---%CF%83%CF%85%CE%BC%CE%BC%CE%B5%CF%84%CE%BF%CF%87%CE%B9%CE%BA%CF%8C-%CF%80%CE%B5%CF%81%CE%B9%CE%B5%CF%87%CF%8C%CE%BC%CE%B5%CE%BD%CE%BF-%CE%B11) |[Click](https://github.com/courses-ionio/help/discussions/1207) | Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br> Υπήρξαν αλλαγές ώσπου το τελικό αποτέλεσμα να εκφράζει το πνεύμα και τους στόχους μου ως προς το μάθημα|
| 4 | [Άσκηση γραμμής εντολών(warm up cli)](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CF%84%CE%AD%CF%84%CE%B1%CF%81%CF%84%CE%B7---%CE%AC%CF%83%CE%BA%CE%B7%CF%83%CE%B7-%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%AE%CF%82-%CE%B5%CE%BD%CF%84%CE%BF%CE%BB%CF%8E%CE%BD-warm-up-cli) | [Click](https://github.com/courses-ionio/help/discussions/1349)| Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br> Εξοικείωση με την γραμμή εντολών |
| 5 | [Συμμετοχικό περιεχόμενο A2](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CF%80%CE%AD%CE%BC%CF%80%CF%84%CE%B7---%CF%83%CF%85%CE%BC%CE%BC%CE%B5%CF%84%CE%BF%CF%87%CE%B9%CE%BA%CF%8C-%CF%80%CE%B5%CF%81%CE%B9%CE%B5%CF%87%CF%8C%CE%BC%CE%B5%CE%BD%CE%BF-%CE%B12) | [Click](https://github.com/courses-ionio/help/discussions/1467)| Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br> Υπήρξαν αλλαγές ώσπου το τελικό αποτέλεσμα να εκφράζει το πνεύμα και τους στόχους μου ως προς το μάθημα|
| 6 | [Κατασκευή του βιβλίου Α](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CE%AD%CE%BA%CF%84%CE%B7---%CE%BA%CE%B1%CF%84%CE%B1%CF%83%CE%BA%CE%B5%CF%85%CE%AE-%CF%84%CE%BF%CF%85-%CE%B2%CE%B9%CE%B2%CE%BB%CE%AF%CE%BF%CF%85-%CE%B1) |[Click](https://github.com/courses-ionio/help/discussions/1577)  | Εμπρόθεσμο παραδοτέο <br>Μερική ολοκλήρωση <br> Η προσθήκη μου είναι σύμφωνη με τις θεματικές ενδιαφέροντός μου ωστόσο θα προτιμούσα η μορφή της να έχει περισσότερο χαρακτήρα το οποίο δεν μπόρεσα να υλοποιήσω  |
| 7 | [Συμμετοχικό περιεχόμενο B1](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CE%AD%CE%B2%CE%B4%CE%BF%CE%BC%CE%B7---%CF%83%CF%85%CE%BC%CE%BC%CE%B5%CF%84%CE%BF%CF%87%CE%B9%CE%BA%CF%8C-%CF%80%CE%B5%CF%81%CE%B9%CE%B5%CF%8C%CE%BC%CE%B5%CE%BD%CE%BF-%CE%B21) |[Click](https://github.com/courses-ionio/help/discussions/1698) | Εμπρόθεσμο παραδοτέο <br>Μερική ολοκλήρωση <br> Ταιριάζει με την προσεγγισή μου , παρείχε μια πιο σφαιρική ματιά στην ιστορία κατασκευής γραφικών ίσως έπρεπε να επικεντρωθεί σε μία μόνο τεχνολογία|
| 8 | [Άσκηση γραμμής εντολών (hci)](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CF%8C%CE%B3%CE%B4%CE%BF%CE%B7---%CE%AC%CF%83%CE%BA%CE%B7%CF%83%CE%B7-%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%AE%CF%82-%CE%B5%CE%BD%CF%84%CE%BF%CE%BB%CF%8E%CE%BD-hci) |[Click](https://github.com/courses-ionio/help/discussions/1785) | Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br> Ευκαιρία για δοκιμές και πειραματισμό για workflow προγραμματισμού και σχεδιασμού γραφικών|
| 9 | [Συμμετοχικό περιεχόμενο B2](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CE%AD%CE%BD%CE%B1%CF%84%CE%B7---%CF%83%CF%85%CE%BC%CE%BC%CE%B5%CF%84%CE%BF%CF%87%CE%B9%CE%BA%CF%8C-%CF%80%CE%B5%CF%81%CE%B9%CE%B5%CF%8C%CE%BC%CE%B5%CE%BD%CE%BF-%CE%B22) |[Click](https://github.com/courses-ionio/help/discussions/1840) | Εμπρόθεσμο παραδοτέο <br>Μερική ολοκλήρωση <br> |
| 10 | [Άσκηση γραμμής εντολών (hci)](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CE%B4%CE%AD%CE%BA%CE%B1%CF%84%CE%B7---%CE%AC%CF%83%CE%BA%CE%B7%CF%83%CE%B7-%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%AE%CF%82-%CE%B5%CE%BD%CF%84%CE%BF%CE%BB%CF%8E%CE%BD-hci) |[Click](https://github.com/courses-ionio/help/discussions/1874) |Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br> Το script θα μου φανεί χρήσιμο για τις σημειώσεις μου |
| 11 | [Κατασκευή του βιβλίου Β](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-e%CE%BD%CE%B4%CE%AD%CE%BA%CE%B1%CF%84%CE%B7---%CE%BA%CE%B1%CF%84%CE%B1%CF%83%CE%BA%CE%B5%CF%85%CE%AE-%CF%84%CE%BF%CF%85-%CE%B2%CE%B9%CE%B2%CE%BB%CE%AF%CE%BF%CF%85-b) |[Click](https://github.com/courses-ionio/help/discussions/2114) |Εκπρόθεσμο παραδοτέο <br>Μερική ολοκλήρωση <br> Κατάφερα να προσθέσω τα κείμενα αλλά όχι και τις εικόνες τους |
| 12 | [Τελική αναφορά](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CE%B5%CE%B2%CE%B4%CE%BF%CE%BC%CE%AC%CE%B4%CE%B1-%CE%B4%CF%89%CE%B4%CE%AD%CE%BA%CE%B1%CF%84%CE%B7---%CF%84%CE%B5%CE%BB%CE%B9%CE%BA%CE%AE-%CE%B1%CE%BD%CE%B1%CF%86%CE%BF%CF%81%CE%AC) | [Click](https://github.com/courses-ionio/help/discussions/2051)| Εμπρόθεσμο παραδοτέο <br>Ολική ολοκλήρωση <br>|
...
&nbsp;&nbsp;&nbsp;
 ...
 Στους υπολογιστές μου προκαλεί το ενδιαφέρον ο όγκος της πληροφορίας που έιναι διαθέσιμοος και οι δυνατότηες που υπάρχουν πάνω σε αυτά. Τα γραφικά και το animation είναι το αγαπήμενο μου στοιχείο τους. Θέλω με κάποιον τρόπο να ασχοληθώ με αυτά. Μέσω του μαθήματος επικοινωνια ανθρώπου υπολογιστή ευελπιστώ να αποκτύσω μια βαθήτερη γνώση για τον τρόπο με τον οποίο ο υπολογιστής διαχειρίζεται αυτή την πληροφ΄ρια και πως συμμετέχει ο άνθρωοπος σε αυτό΄.Ακόμα ποιος είναι ο ρόλος των γραφικών στην διάδραση. Μέσα από τις εργασίς θέλω να πειραματιστώ και να ερευνήσω διάφορα εργολεία που θα μπορούσα να χρησιμοποιώσω στις δρασρητριο΄τητες μου ως φοιτητής αλλά και για τις καθημερινές ανάγκες μου. Ειδικά επιθυμώνα να αναπτύξω ικανότητες για την οργάνωση και διαχείριση ενός πρόζεκτ. Να μάθω scripting για αυτοματισμό και μεθόσους για να τα συνδιάσω και να δημιουργλω εργαλεία που θα με βοηθούν στα γραφικά και οτιδείποτε άλλο με ενδιαφέρει. Με τα εφόδια αυτά θέλω στο μέλλον να συμμετέχω είτε δημιουργλοντας δικά μου έιτε συνησφερονταν σε άλλους αποκ΄τοαντας εμπιρία δουλεοντας σε περιβάλλον ομλαδας όπως σε πργατικές συνθηκες για να έχω μια βάση για τα βηματά μου ως μελλοντικός επαγγελμςτιίας.
...
&nbsp;&nbsp;&nbsp;Η εγκατάσταση του arch linux ήταν μια δύσκολη διαδικασία στην αρχή. Χρειάστηκαν μερικές προσπάθειες σε εικονική μηχανή ,συγκεκριμένα το VirtualBox πριν προχωρίσω σε εγκατάσταση σε πραγματικό υλικό. Βρήκα πιο εύκολο να ακολουθήσω tutorial  στο youtube,καθώς έτσι μπορούσα να έχω καλύτερη επεξήγηση για τις ενέργειες που έκανα, και το arch wiki μόνο για μια δεύτερη πηγή βοήθειας. Με τον τρόπο αυτό κατάφερα να εγκαταστήσω από την εβδομάδα αυτή το λογισμικό στο παλιό μου laptop από το οποίο διέγραψα το παλιό λειτουργικό (windows 8). Παρακάτω φαίνονται τα neofetch και journal.
...
<br />
&nbsp;&nbsp;&nbsp;Για το συμμετοχικό περιεχόμενο Α1 έγινε αναζήτηση στο διαδίκτυο για την προσθήκη δύο νέων εικόνων στο περιεχόμενο του βιβλίου. Οι επιλογές μου φαίνονται στις παρακάτω εικόνες και είναι από πάνω προς τα κάτω το Blender και το Houdini. Το blender πρόκειται για ένα ελεύθερο λογισμικό δημιουργίας 3D μοντέλων, animetion ,video και άλλων,ενώ το houdini είναι επαγγελματικό πρόγραμμα ψηφιακών εφέ και προσομοιώσεων. Τo houdini αντικατέστησε την αρχική μου επιλογή amiga workbench καθώς ήταν πιο σύμφωνο με το πνεύμα των θεματικών που ανέφερα στην εισαγωγή. Η εικόνα του blender άλλαξε επίσης ώστε να φαίνονται καλύτερα τα διαδραστικά μέρη του λογισμικού.
...
&nbsp;&nbsp;&nbsp;Για την δημιουργία του thumbnail χρησιμοποιήθηκε αυτό το [ονλάιν πρόγραμμα επεξεργασίας εικόνας](https://www9.lunapic.com/editor/?action=scale).Για το κάθε ένα δημιουργήθηκαι ένα ξεχωριστό αρχείο **markdown** με όλα τα απαραίτητα στοιχεία. Για να ανέβουν στο  github έπρεπε να γίνει εγκατάσταση των αποθετηρίων site, _gallery,images αφού προηγουμένος είχε γίνει αντίστοιχο fork αυτών στο github profile μου μέσω του **ομαδικού οργανισμού**.Η ομάδα μας αντιμετώπισε προβλήματα λόγου ελλειπή αρχικού χειρισμού των αποθετηρίων ,αλλά αντιμετωπίστηκαν με την μεταξύ μας συνεργασία, τους οδηγούς συμφοιτητών, και εξωτερικών πηγών από το διαδίκτυο.
...
Σύνδεσμος για το ανανεωμένο neofetch
...
Η εβδομάδα αυτή αφορούσε την δημιουργία ενός νέο χρονολογίου και μίας νέας θεματικής διαφάνειας για κάθε μια από τις εικόνες της τρίτης εβδομάδας. Η  διαδικασία ήταν σχετικά απλή καθώς τα βήματα ήταν είδη γνωστά από το παραδοτέο 3. Τα χρονολόγια και η διαφάνειες που έγιναν οι προσθήκες μου κατασκευάστηκαν σε συνεργασία με μέλη της ομάδας που είχαμε παρόμοιες θεματικές. Η δική μου συνεισφορά ήταν 
* Διαφάνειες:  προσθήκη σε προσομοίωση και σχεδιασμός γραφικών
* Χρονολόγιο:  προσθήκη σε γραφικά υπολογιστών και επαυξημένη πραγματικότητα
 ### Timeline
...
&nbsp;&nbsp;&nbsp;Για την κατασκευή του βιβλίου Α έγινε εγκατάσταση του εργαλείου pandoc και του πακέτου texlive-most. Επιπλέον χρειάστηκε να εγκατασταθεί και το φίλτρο pandoc-fignos. Για την προσθήκη της σημείωσης δημιουργήθηκε ένα md αρχείο στο φακελο **contribution** στο αποθετήριο kallipos αφού προηγουμένως έγινε fork από το κεντρικό. Το φίλτρο που χρησιμοποίησα είναι μια μικρή παραλλαγή του extras.lua. Η σημείωση προτέθηηκε στο κεφάλαιο της σύνθεσης καθώς περιγράφει πώς οι χρήστες του λογισμικού blender μπορούν να χρησιμοποιήσουν τις δυνατότητες της εφαρμογής ώστε να κατασκευάσουν τις δικές τους μορφές διάδρασης μαζί της.
...
&nbsp;&nbsp;&nbsp; Η μελέτη περίπτωσης μου αφορά την εξέλιξη μέσα στον χρόνο των λογισμικών κατασκευής τρισδιάστατων γραφικών και τα χαρακτηριστικά εκείνα που αποτελούν το λόγο που έχουν την σημερινή τους μορφή και πώς είναι ικανή να αλλάξει στο μέλλον.
...
|   [3dsoftware](https://testsite-inf2021090.netlify.app/case-study/graphics-3d/)   |   [3dsoftware](https://github.com/inf2021090/site/blob/par-7-test/_case-study/graphics-3d.md)    |   [pull req]()           |
 ...
 [βιβλιογραφία:page_with_curl:](https://github.com/inf2021090/hci/blob/2021090/projects/2021090/README.md#%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF-7)
...
&nbsp;&nbsp;&nbsp;Από την λίστα των διαθέσιμων ασκήσεων επέλεξα αυτή που ζητά να χρησιμοποιήσουμε το τερματικό σαν IDE. Δημιούργησα ένα bash script που σετάρει το περιβάλλον για εργασία. Επιπλέον δημιούργησα ένα δεύτερο script το οποίο πραγματοποιεί ένα render σε ένα αρχείο blender(.blend) για την δημιουργία μιας εικόνας που χρησιμοποιήθηκε στο πρόγραμμα. Χρησιμοποίησα και το w3m για γρήγορη αναζήτηση βοήθειας. Η άσκηση εντάσσεται στους ευρύτερους στόχους μου για το μάθημα και συγκεκριμένα στην δημιουργία δικών μου εργαλείων για βοήθεια στην κατασκευή γραφικών.

[![asciicast](https://asciinema.org/a/P1QVQPXani3qjHNzRm7kR6cua.svg)](https://asciinema.org/a/P1QVQPXani3qjHNzRm7kR6cua)
...
&nbsp;&nbsp;&nbsp; Το έργο του Myron Krueger και οι απόψεις του για την διάδραση παρουσιάζουν ιδιαίτερο ενδιαφέρον από την οπτική των τρισδιάστατων γραφικών και τον ρόλο τους στην διάδραση για αυτό και επέλεξα την περίπτωσή του για την βιογραφία στο ζητούμενο αυτού του παραδοτέου.
...
&nbsp;&nbsp;&nbsp;Σε αυτή την άσκσηση γραμμής εντολών αξιοποιώντας γνώσεις από παραδοτέα προηγούμενων εβδομάδων δημιούργησα ένα script που μετατρέπει αρχεία vimwiki σε pdf ή latex.

[![asciicast](https://asciinema.org/a/Y5jCdJwbq554XwwVSGytPNdBk.svg)](https://asciinema.org/a/Y5jCdJwbq554XwwVSGytPNdBk)
...
### Συμπεράσματα
&nbsp;&nbsp;&nbsp;Το μάθημα επικοινωνία ανθρώπου υπολογιστή έφτασε στο τέλος του, παρά τις όποιες δυσκολίες προέκυψαν έπειτα από εντατική προσπάθεια όλα τα παραδοτέα ολοκληρώθηκαν. Η εμπειρία μου αυτές τις εβδομάδες χαρακτηρίζεται κυρίως από τον τρόπο σκέψης που τα βέντεο-κουιζ και οι εργασίες ανάγκασαν να αναπτύξω. Αρχικά ακούγοντας πρωτοπόρους(τους οποίους δεν γνώριζα ) του κλάδου να μιλούν οι ίδιοι για τις εμπειρίες και τις απόψεις τους με έκανε να αναρωτηθώ και να αμφισβητήσω πολλές από τις εφαρμογές διάδρασεις που χρησιμοποιώ και εγώ ο ίδιος στην καθημερινότητα μου για τον τρόπο που λειτουργούν. Τέτοια θέματα ήταν η χρήση του ποντικιού, η “δυσκολία του πληκτρολογίου” καθώς οι “έξυπνες” εφαρμογές που παίρνουν τον έλεγχο από τον χρήστη και αντί να έχουν ακριβή ανταπόκριση  προσπαθούν να μαντέψουν ποια θα είναι η επόμενη κίνηση του πέφτοντας έξω. Κλονίστηκαν επίσης κάποιες πεποιθήσεις που είχα για τον χώρο ,ως πιο ‘’αγαθό’’ σε σχέση με άλλους ,και αντιλήφθηκα ότι μια ευρεσιτεχνία κυριαρχεί όχι πάντα λόγω ιδιοφυούς σχεδιασμού αλλά επειδή υπάρχουν κερδοσκοπικά συμφέροντα που θα κάνουν την ανάλογη προώθηση . Πράγματι το συμφέρον αυτή την εποχή(και όχι μόνο) συστήνει την εξέλιξη του υπολογιστή και παραγκωνίζει τον άνθρωπο έτσι πλέον είμαι πιο κριτικός απέναντι σε ζητήματα που προβλημάτισαν στο παρελθόν ,όπως η τεχνητή νοημοσύνη η οποια για μπορεί να λειτουργήσει και να παρέχει εύκολα δεδομένα παραβιάζει τα προσωπικά δεδομένα του καθένας. Έχοντας πλέον ένα πιο σταθερό σημείο εκφρασης που ανταποκρίνεται περισσότερο στην πραγματικότητα παρά στις ταινίες επιστημονικής φαντασίας. Αν και όλα αυτά ίσως προαναγγέλλουν ένα ζοφερό μέλλον προσωπικά με αφορούν μέχρι ένα σημείο ως άνθρωπο και μελλοντικό επιστήμονα πληροφορικής; αυτό που έχει πραγματική σημασία για την ώρα είναι ότι σε εφαρμογές που χρησιμοποιώ καθημερινά για τις πανεπιστημιακές και μη υποχρεώσεις μου τα αντιμετωπίζω με περισσότερη κριτική σκέψη και προτιμώ να αφιερώσω περισσότερο χρόνο στο να μάθω να χειρίζομαι κάποια που θα μου επιτρέπει να είμαι πιο αποτελεσματικός. Έχοντας έρθει σε επαφή με διάφορα εναλλακτικά εργαλεία για την περάτωση των εργασιών καθώς και μπαίνοντας σε μια διαδικασία αναζήτησης για την αντιμετώπιση των προβλημάτων που εμφανίζονταν στην πορεία αυτό είναι πλέον πολύ πιο εύκολο. Θωρώ λοιπόν πως έχω χτίσει τις απαραίτητες βάσεις για να ασχοληθώ με μεγαλύτερη ακρίβεια και αποτελεσματικότητα αλλά και οργάνωση σε όποιο πρότζεκτ με ενδιαφέρει όπως να ασχοληθώ πιο εντατικά με τα γραφικά και συγκεκριμένα το blender και την δημιουργία δικών script ή εργαλείων ή ακόμα να συνεισφέρω ενεργά στα github της κοινότητας του. Κάτι τελευταίο που αφορά τα γραφικά είναι επιβεβαίωση ότι η υψηλή ανάλυση δεν είναι απαραίτητη όταν θες να περάσεις ένα μήνυμα ,έτσι στην διάδρση σημασία έχει να τονιστούν τα χαρακτηριστικά εκείνα που καθιστούν το μήνυμα σαφές για μια προσπάθεια επικοινωνίας 
<br />
...
|[παλιό](https://github.com/ContattoContare/site/pull/2)|
