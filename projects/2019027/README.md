...
## Σύντομη εισαγωγή
Στο μάθημα αυτό ασχολήθηκα με δύο διαφορετικές πλευρές της διεπαφής ανθρώπου / υπολογιστή - τη γραφική διεπαφή στο web και τη διεπαφή γραμμής εντολώ στο linux. Απέκτησα αρκετές νέες γνώσεις και παράλληλα ήρθα σε επαφή με εργαλεία όπως το github, το Netlify, το CodePen που θεωρώ ότι είναι πολύ χρήσιμα για έναν πληροφορικό. Παρακάτω περιγ΄ραφω αναλυτικότερα τα θέματα με τα οποία ασχολήθηκα.
