...
| 4 | Άσκηση γραμμής εντολών | |Εγκατάσταση του 9legacy OS και στήσιμο του από την αρχή ώστε να νιώσω ανετος με την γραμμη εντολων.|
...
| 11 | Κατασκευή του βιβλίου Β | | Το ζητούμενο δεν καλύφθηκε|
