...
<h2><span id="Εισαγωγή">Εισαγωγή</span></h2>
   ...
   Στο πρόγραμμα σπουδών του χειμερινού εξαμήνου υπήρχε το μάθημα Επικοινωνία Ανθρώπου-Υπολογιστή, το οποίο θεωρώ πως είναι ενα ενδιαφέρον μάθημα, καθώς έχεις την δυνατότητα να μάθεις και να κατανοήσεις την διάδραση που υπάρχει μεταξύ χρήστη και υπολογιστικού συστήματος. Ωστόσο, το μάθημα, σε τεχνικό κυρίως επίπεδο, είχε και αρκετές δυσκολίες, όπως την αφομοίωση της λειτουργίας κάποιων εργαλείων (asciinema, codepen, netlify), αλλά και της ίδιας της πλατφόρμας που χρησιμοποιούμε για την δημιουργία της αναφοράς μας (github).
 ...
 <h2><span id="Άσκηση Προγραμματισμού 3η">Άσκηση Προγραμματισμού 3η</span></h2>
  ...
  Βιβλιογραφία:
   ...
   Φτάνοντας στο τέλος του εξαμήνου, κατάφερα να κατανοήσω πλήρως την λειτουργία των διαφόρων εργαλείων που μας δώθηκαν, καθώς και της ίδιας της πλατφόρμας github. Όλα αυτά τα εργαλεία μπορούν να φανούν εξαιρετικά χρήσιμα σε μελλοντικές εργασίες και μαθήματά μας. Ταυτόχρονα, το μάθημα αποτέλεσε μια καλή βάση για την μετέπειτα εξέλιξή μας στο κομμάτι της επικοινωνίας ανθρώπου-υπολογιστή, γνωρίζοντας διάφορα συστήματα και εργαλεία που εξυπηρετούν αυτόν τον σκοπό, καθώς και διάφορες και σημαντικές προσωπικότητες που βοήθησαν στην εμφάνιση και την εξέλιξη των συστήματων αυτών.
