<div style="text-align:center">
    <h1> Ιονιο Πανεπιστήμιο <br/>Τμήμα Πληροφορικής</h1>

</div>

# Mάθημα : Επικοινωνία Ανθρώπου Υπολογιστή
...
| 4 | [Άσκηση προγραμματισμού](#εβδομαδα-4η)  |
| 5 |[ Άσκηση γραμμής εντολών](#εβδομαδα-5η) |
| 6 | [Συμμετοχικό περιεχόμενο](#εβδομαδα-6η)  |
| 7 |[Ασκηση προγραμματισμου](#εδβδομαδα-7η)  |
| 8 |[Γραμμης εντολών](#εβδομαδα-8η) |
| 9 | [Προγραμματισμου](#εβδομαδα-9η) |
| 10 | [Γραμμης Εντολων](#εβδομαδα-10η)|
| 11 | [Συμμετοχικό περιεχόμενο](#εβδομαδα-11η)|
| 12 | [Τελική αναφορά](#εβδομαδα-12η)  |
...
Μια απλη άσκηση περιήγησης στην γραμμή εντολών
...
Στο τευλεταίο συμμετοχικό περιεχόμενο έγινε ενα case study πάνω στο Tensorflow.
Δυστηχώς δεν μπορούσα να κανω βιογραφία καθώς πίσω απο το Tensorflow βρίσκεται μια ομάδα απο αρκετούς επιστήμονες(Google Brain Team)

## Εβδομαδα 12η

Με το κλείσιμο της παρούσας αναφοράς θα ηθέλα να σταθώ στα εξής
* Το μάθημα μέσα απο τις διαλέξεις κατάφερε να αναδείξει μια πίο ιστορική πλέυρα της επικοινωνίας ανθρώπου-υπολογιστή καθώς και δίαφορες μορφές αλληλεπίδρασης με τον υπολογιστή που θεωρήθηκαν καινοτόμες για την εποχή τους.Κάποιες απο αυτές της μορφές αλληλεπίδρασης έθεσαν της βάσεις και τους βασικούς κανόνες για την ανάπτυξη του συμερινού μοντέλου διεπαφής με τον υπολογιστή , ενα μοντέλο το οποίο χρησιμοποιείται απο ολα τα λειτουργίκα και υπολογιστηκά συστήματα τόσο σε μικρή οσο και σε μεγάλη κλίμακα (Προσωπικός υπολογιστής, διεπαφή με  περιβάλλον server).

* Μέσα απο το πρακτικό κομμάτι του μαθημάτος (Ασκήσεις προγραμματισμού,γραμμής εντολών και συμμετοχικό περιεχόμενο) αναδείκτηκε σε μεγάλο βαθμό ο τρόπος διεπαφής με τον υπολογιστή τοσο ο τωρινος(UX,GUI) οσό και ο πιο "Ιστορικος" (Terminal). Aν και είχα ήδη κάποια εμπειρία με το Web Development πιστεύω πως οι ασκήσεις προγραμματισμού  καταφέρνουν με επιτυχία τον φοιτητή σε μια πρώτη επαφή με τον προγραμματισμό ενός περιβάλλοντος  με το οποίο αλληλεπιδρά ο χρήστης με τον Υπολογίστη. 
* Οι ασκήσεις  γραμμής εντολών  ήταν μια καλή ευκαιρία για μια πρώτη επαφή με το τερματικο Linux/UNIX ,για όσους δεν είχαν ξανα δουλέψει ποτέ σε τέτοιο περιβάλλον, κάθως καλύπτουν ,κατα την γνώμη μου, ενα ευρύ πέδιο εργασίων στο τερματικο.


* Mε το συμμετοχικό περιεχόμενο κατάφερα να αποκομίσω περισσότερες πληροφορίες σχετικα με τα εργαλεία διεπαφης που μελέτησα(tensorflow,pycharm).Αυτές οι μελέτες με βοήθησαν να κατανοήσω καλύτερα πόσο σημαντική είναι διεπαφή προγραμματιστή-υπολογίστη κάθως προκείται για ενα  θέμα που δεν ακούγεται συχνα δίοτι με τον όρο επικοινωνία ανθρώπου-υπολογιστή τείνουμε να αναφερόμαστε στον χρήστη και όχι στον προγραμμτιστή.