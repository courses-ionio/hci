...
| 2 |<a href="Άσκηση προγραμματισμού 1η"></span> <span class="toctext">Άσκηση προγραμματισμού 1η</span></a> |Πρώτη συμμετοχή σε project τέτοιας κλίμακας, εξοικίωση με git, submodules, netlify|
| 3 |<a href="Άσκηση γραμμής εντολών 1η"></span> <span class="toctext">Άσκηση γραμμής εντολών 1η</span></a>| Πρώτη επαφή με arch, πρώτη επαφή με τερματικό|
| 4 |<a href="Άσκηση προγραμματισμού 2η"></span> <span class="toctext">Άσκηση προγραμματισμού 2η</span></a> |Επιπλέον εξοικίωση με το συγκεκριμένο project|
| 5 | <a href="Άσκηση γραμμής εντολών 2η"></span> <span class="toctext">Άσκηση γραμμής εντολών 2η</span></a> |Εμφάνιση του αρχείο shell configuration  και να εμφανίσουμε πληροφορίες συστήματος (υλικό + λογισμικό)|
| 6 | Συμμετοχικό περιεχόμενο|
| 7 | <a href="Άσκηση προγραμματισμού 3η"></span> <span class="toctext">Άσκηση προγραμματισμού 3η</span></a> |Συνδυασμός φίλτρων εικόνας και τη χρήση zoom κατά τη λειτουργία hover (κίνηση του ποντικιού πάνω από την εικόνα) |
| 8 |<a href="Άσκηση γραμμής εντολών 3η"></span> <span class="toctext">Άσκηση γραμμής εντολών 3η</span></a> |Eξοικίωση με το πρόγραμμα επεξεργασίας κειμένου και με τις προσθήκες για επισήμανση του κώδικα και αυτόματη συμπλήρωση |
| 9 | <a href="Άσκηση προγραμματισμού 4η"></span> <span class="toctext">Άσκηση προγραμματισμού 4η</span></a> |Επιπλέον συνδιασμός φίλτρων εικόνας και τη χρήση zoom κατά τη λειτουργία hover (κίνηση του ποντικιού πάνω από την εικόνα)|
| 10 | <a href="Άσκηση γραμμής εντολών 4η"></span> <span class="toctext">Άσκηση γραμμής εντολών 4η</span></a>|Διαμόρφωση του περιβάλλον του προγράμματος περιήγησης στο τερματικό πρόγραμμα περιήγησης |
| 11 | Συμμετοχικό περιεχόμενο |
| 12 |<a href="Τελική Αναφορά"></span> <span class="toctext">Τελική Αναφορά</span></a> |Ικανοποίηση στόχων|
