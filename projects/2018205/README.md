...
| 8 | Άσκηση γραμμής εντολών |[Παραδοτέο 8](https://github.com/courses-ionio/help/discussions/1772)|Ο στόχος της εργασίας είναι να διαμορφώσουμε το περιβάλλον του προγράμματος περιήγησης στο τερματικό πρόγραμμα περιήγησης. |
| 9 | Συμμετοχικό περιεχόμενο B2 |[Παραδοτέο 9](https://github.com/courses-ionio/help/discussions/1855)| Στο συγκεκριμένο παραδοτέο καλούμαστε να προσθέσουμε μια νέα βιογραφία στο site του βιβλίου του μαθήματος. Η βιογραφία που επέλεξα αφορά τον Steven Paul Jobs.|
| 10 | Άσκηση γραμμής εντολών |[Παραδοτέο 10](https://github.com/courses-ionio/help/discussions/1928) |Στόχος της εργασίας είναι να εξοικειωθούμε με το πρόγραμμα επεξεργασίας κειμένου και με τις προσθήκες για επισήμανση του κώδικα και αυτόματη συμπλήρωση.|
| 11 | Κατασκευή του βιβλίου Β |[Παραδοτέο 11](https://github.com/courses-ionio/help/discussions/1976) |Στο συγκεκριμένο παραδοτέο καλούμαστε να φτιάξουμε τη δική μας εκδοχή του βιβλίου του μαθήματος σε μορφή EPUB για το HCI και για το SW σε μορφή Pollen. |
| 12 | Τελική αναφορά* | [Παραδοτέο 12](https://github.com/courses-ionio/help/discussions/1974)|Στην τελική αναφορά μου, αποτύπωσα τα συμπεράσματα μου μέσα από τις εργασίες που κλήθηκα να εκτελέσω. |
...
# Παραδοτέο 9
Στο συγκεκριμένο παραδοτέο καλούμαστε να προσθέσουμε μια νέα βιογραφία στο site του βιβλίου του μαθήματος. Η βιογραφία που επέλεξα αφορά τον Steven Paul Jobs , ο οποίος ήταν Αμερικανός επιχειρηματίας , βιομηχανικός σχεδιαστής , ιδιοκτήτης μέσων ενημέρωσης και επενδυτής. 

[Βιογραφία](https://github.com/despina-komo/site/blob/69b97cd884ae14e066a9902fede074c11481a7c5/Steven%20Paul%20Jobs.md)

[Includes](https://github.com/despina-komo/site/blob/0e174eb3daa0ff24b769411855d470272afcc3ae/includes/Steven%20Paul%20Jobs.md)
...
Στο συγκεκριμένο παραδοτέο καλούμαστε να φτιάξουμε τη δική μας εκδοχή του βιβλίου του μαθήματος σε μορφή EPUB για το HCI και για το SW σε μορφή Pollen. Δυστυχώς δεν τα κατάφερα να την υλοποιήσω αλλά υπόσχομαι να προσπαθήσω περισσότερο για να ολοκληρώσω.
...
Μεσα από τους πιο πάνω στόχους που κατάφερα να  υλοποιήσω, μου δόθηκε η ικανότητα να κατανοήσω πιο πολύ το περιβάλλον του git hub και του linux, και ακόμη να ενημερωθώ περισσότερo για την επικοινωνία μεταξύ ανθρώπου και υπολογιστή. Μπαίνοντας σε αυτό το μάθημα δεν γνώριζα τίποτα περί linux και github. Ωστόσο πλέον μπορώ να πω πως έχω έστω μια βασική εξοικίωση με τα εν λόγω συστήματα. Επιπλέον, η εμπειρία που απέκτησα δουλεύοντας πάνω σε project όπως το pibook είναι χρήσιμη καθώς μου έδωσε μια ιδέα για το πως συνεργάζονται προγραμματιστές μεγάλων project.
...
# Video Quiz
Έχουν ολοκληρωθεί όλα τα video quiz: 11/11
