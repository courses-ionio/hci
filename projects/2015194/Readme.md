...
| --- | --- | --- |
| 1 |[Εισαγωγή](#εισαγωγή) | Συγγραφή Εισαγωγής, Στόχων και Προσδοκιών για την υλοποίηση των ασκήσεων. Εξοικίωση με το github και τις λειτουργίες του (fork, pull request, commit etc.) |
...
Στην αρχή της υλοποίησης των ασκήσεων στόχος μου είναι η ουσιαστική και δια βίου κατανόηση του μαθήματος, αλλά και του ρόλου της διάδρασης του ανθρώπου με τον υπολογιστή. Συγκεκριμένα, βασικός στόχος είναι η εξοικείωσή μου με το Github, αλλά και τις λειτουργίες αυτού (Fork, Commit, Pull Request, Δημιουργία αρχείων κλπ). Η εξικοιώση μου με το Github θα οδηγήσει στην γρηγορότερη και πιο σωστή υλοποίηση των παραδοτέων του μαθήματος.
<br />
