...
Πιστεύω πως οι αρχικοί μου στόχοι καλύφθηκαν σε ένα μεγάλο βαθμό, παρότι υπήρχαν δυσκολίες σε μερικά παραδοτέα. Έμαθα να χρησιμοποιώ το Github και κάποιες βασικές λειτουργίες του Git, ασχολήθηκα με τις γλώσσες προγραμματισμού HTML, CSS Javascript και απέκτησα μία οικειότητα με το λειτουργικό σύστημα Linux. Όσο για το αντικείμενο του μαθήματος είδα πως ήταν τα παλιότερα λειτουργικά συστήματα και πως ήταν οι παλιοί τρόποι διάδρασης του ανθρώπου με τον υπολογιστή.
