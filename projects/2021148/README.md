...
4. Έχοντας εισάγει το usb-stick που προανέφερα στην συσκευή μου εκτέλεσα μέσα από τις ρυθμίσεις την επαννεκίνηση για προχωρημένους.

5. Μετά την επαννεκίνηση επέλεξα να κάνει boot η συσκευή από το usb-stick κι έτσι ξεκίνησα την εγκατάσταση.
(Σε αυτό το σημείο είχα ένα σφάλμα το οποίο για να αντιμετωπίσω χρειάστηκε να αποκτήσω πρόσβαση στα BIOS του υπολογιστή μου και να απενεργοποιήσω το Secure Boot  για να γίνει εκκίνηση του υπολογιστή από το usb-stick κι έπειτα να ξεκινήσα την εγκατάσταση.)

6. Έλεγξα την εγκυρότητα των αρχείων του συστήματος EFI.

7. Εφόσον είχα δώσει προηγουμένως(βήμα 3) τον απαραίτητο χώρο μνήμης από τον σκληρό δίσκο, με την εκτέλεση της εντολής cfdisk πρχώρησα στη δημιουργία ενός Linux Filesystem και ενός Linux Swap.
...
9. Μετά την εγκατάσταση του λειτουργικού συστήματος και όλων των απαραίτητων αρχείων προχώρησα στην διμουργία χρηστών καθώς και στην εφαρμογή ενός grub menu το οποίο θα εμφανίζεται κατά την εκκίνηση του υπολογιστή για την επιλογή είτε του λειτουργικού συστήματος των Arch Linux είτε των Windows.
