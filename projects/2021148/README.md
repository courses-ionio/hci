...
slides(διαφάνεια): [Εφαρμογές της Apple](https://github.com/inf2021148/site/blob/master/_slides/apple_applications.md)

timeline(χρονολόγιο): [Το διαδικτυακό κατάστημα της Apple](https://github.com/inf2021148/site/blob/master/_timeline/apple_store.md) 
