...
Σημειώνω ότι τα ζητούμενα των συμμετοχικών περιεχομένων είναι έτοιμα (το απαραίτητο κείμενο και οι αντίστοιχες εικόνες) όμως δεν μπόρεσα να τα αναρτήσω στην θέση τους στο site.
