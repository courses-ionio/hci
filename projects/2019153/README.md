...
| --- | --- | --- | --- |
| 1 |  [Δημιουργία ομάδας](#παραδοτέο-1) |[Discussion](https://github.com/courses-ionio/hci/discussions/1794#discussioncomment-3803609), [Organization](https://github.com/Second-Time-Is-The-Charm/Main), [Show & tell](https://github.com/courses-ionio/help/discussions/823)| το παραδοτέο έγινε με επιτυχία 10/10 |
| 2 | [Άσκηση γραμμής εντολών (linux install)](#παραδοτέο-2) |[Neofetch](https://asciinema.org/a/527935) ,[journalctl -b](https://asciinema.org/a/527939), [Show and tell](https://github.com/courses-ionio/help/discussions/1051)| το παραδοτέο έγινε με επιτυχία 10/10 |
| 3 | [Συμμετοχικό περιεχόμενο A1](#παραδοτέο-3) | [discussion](https://github.com/courses-ionio/help/discussions/1164), [my site](https://voltmaister-site1.netlify.app/), [pull request .md files](https://github.com/Second-Time-Is-The-Charm/_gallery/pull/1), [pull request images + thumb](https://github.com/Second-Time-Is-The-Charm/images/pull/1), [organization site vision](https://stitc-site.netlify.app/gallery/vision/), [organization site amigaos](https://stitc-site.netlify.app/gallery/amigaos/)| το παραδοτέο έγινε με επιτυχία 10/10 |
| 4 | [Άσκηση γραμμής εντολών](#παραδοτέο-4) | [discussion](https://github.com/courses-ionio/help/discussions/1346), [googler](https://asciinema.org/a/533238)| το παραδοτέο έγινε με επιτυχία 10/10 |
| 5 | [Συμμετοχικό περιεχόμενο A2](#παραδοτέο-5) |[discussion](https://github.com/courses-ionio/help/discussions/1445)| το παραδοτέο έγινε με επιτυχία 10/10 |
| 6 | [Κατασκευή του βιβλίου Α](#παραδοτέο-6) | [discussion](https://github.com/courses-ionio/help/discussions/1546), [my kallipos](https://github.com/voltmaister/kallipos) | το παραδοτέο έγινε με επιτυχία 10/10 |
| 7 | [Συμμετοχικό περιεχόμενο B1](#παραδοτέο-7) | [discussion](https://github.com/courses-ionio/help/discussions/1592) | το παραδοτέο έγινε με επιτυχία 10/10 |
| 8 | [Άσκηση γραμμής εντολών](#παραδοτέο-8) | [discussion](https://github.com/courses-ionio/help/discussions/1830) | το παραδοτέο έγινε με επιτυχία 10/10 |
...
Στο μάθημα Διάδραση Ανθρώπου-Υπολογιστή ευελπιστώ να καταλάβω και να χρησιμοποιήσω διάφορες τεχνολογίες που στοχεύουν στη διάδραση και την αποδοτικότητα στο τομέα του προγραμματισμού. Θέλω να μάθω τόσο για το τερματικό και τις λειτουργίες που μπορεί να προσφέρει όσο και για το γραφικό περιβάλλον. Θέλω να δώσω ιδιαίτερη ουσία στις βάσεις των σημερινών υπολογιστών καθώς και το ποιος τις διατύπωσε πρώτος και πως εξελίχθησαν στη συνέχεια. Μέσω του μαθήματος πιστεύω ότι μπορώ να μάθω τα παραπάνω αφού θα ασχοληθούμε με μια μεγάλη ποικιλία εργαλείων και τεχνολογιών όπου προσωπικά δεν έχω ξαναχρησιμοποιήσει ή δεν έχω χρησιμοποιήσει τόσο πολύ, όπως για παράδειγμα εργαλεία όπως το pandoc ,lua filters ,spacevim και άλλα. 
...
Στο τέλος του μαθήματος και των εβδομαδιαίων εργασιών συμπέρανα ότι κάθε βδομάδα μου έμαθε και κάτι καινούριο είτε αυτό ήταν κάποιο καινούριο εργαλείο , κάποια καινούρια τεχνολογία αλλά μου έμαθε ακόμα και πως να λειτουργώ συνεργατικά και διεξοδικά για ένα όμορφο αποτέλεσμα καθώς και το πως να κάνω εκτενή έρευνα για αντικείμενα ενδιαφέροντος με σκοπό τη σύνταξη μιας αναφοράς η μιας μελέτης. 
