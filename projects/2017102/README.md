...
Οι στόχοι μου για αυτό το μάθημα:
  ...
  3. Κάτι το οποίο κεντρίζει αρκετά το ενδιαφέρον μου είναι καινοτομίες (είτε είναι συσκευές είτε είδος διάδρασης) που έχουν παρουσιάσει μεγάλο αντίκτυπο στη γενικότερη κουλτούρα που εκπροσωπεύουν. Μέσω αυτού του μαθήματος ελπίζω να αναδείξω τέτοια ευρήματα τεχνολογίας. 
