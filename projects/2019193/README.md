...
| 3 | [Άσκηση γραμμής εντολών Set-up the main dependencies and demonstrate your base system](#Άσκηση-γραμμής-εντολών-Εισαγωγικά-στο-bash)| 
...
# Άσκηση γραμμής εντολών Εισαγωγικά στο bash
Χωρισμένη σε 2 μέρη.
