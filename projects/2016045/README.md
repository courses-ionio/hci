...
Ολοκληρώνοντας το εξάμηνο και το μάθημα Επικοινωνία Ανθρώπου Υπολογιστή πολλοί απο τους αρχικούς στόχους που έθεσα δεν εκπληρώθηκαν πλήρως.Απέκτησα αρκετές γνώσεις πάνω στα πρώτα λειτουργικά συστήματα και για τη πορεία της εξέλιξής τους.Με τις εβδομαδιαίες ασκήσεις ανέπτυξα έναν ικανοποιητικό βαθμό κατανόησης του github και θέλω να συνεχίσω να το χρησιμοποιώ στο μέλλον για να γίνω καλύτερος σε αυτό.Όσο αφορά το Linux στην αρχή κατάφερα να ανταπεξέλθω στα ζήτουμενα των ασκήσεων αλλά αντιμετώπισα μερικά προβλήματα με το σύστημα στον υπολογιστή μου τα οποία με αποθάρρυναν και με μπέρδεψαν με αποτέλεσμα να το αμελήσω.Μια καλή λύση θα ήταν η ενασχόληση με το Linux στον ελεύθερο μου χρόνο χωρίς την πίεση των παραδοτέων.Καταλήγοντας το μάθημα είναι μια πολύ καλή εισαγωγή σε κάποια χρήσιμα εργαλεία για έναν προγραμματιστή.
...
https://askubuntu.com/
https://snapcraft.io/install/cheat/ubuntu
