...
| 2 | [Άσκηση γραμμής εντολών (linux install)](#παραδοτεο-2---περιγραφή-εγκατάστασης-arch-linux) | [Discussion Link - Παραδοτέο 2](https://github.com/courses-ionio/help/discussions/1125) | Δεν ήταν δύσκολη διαδιδκασία, εγκατέστησα Virtual Machine (προσωρινά) για την εγκατάστση του ArchLinux και έπειτα προσπάθησα να "σετάρω" τον λογαριασμό μου καθώς και οτιδήποτε διαδικαστικό για την ομαλή χρήση του λειτουργικού συστήματος. Τέλος, για λόγους εξοικείωσης έτρεξα μερικές εντολές και πραγματοποίησα μία άσκηση warm-up. |
