...
#### NOTE: The above entries were copied from their original branch because ~~there was an issue merging from upstream to base branch~~. The issue was discussed [here](https://github.com/courses-ionio/help/issues/47#issuecomment-573231636). The 'Commit' section refers to the initial publications, please consider these dates instead. The conflict has since been fixed to include all commints from both branches. You may still want to use the 'Commit' section above for quick access to initial commits as there have been many changes ever since the original branches and the final pull request.
...
&#x2611; : No conflicts from this point onward. You may access [history](https://github.com/provopoulos/hci/commits/master/projects/2018017/README.md) to view corresponding commits for the following tasks.
