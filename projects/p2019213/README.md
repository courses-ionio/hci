...
| 12 | [Τελική αναφορά](https://github.com/p19tzam/hci/blob/p2019213/projects/p2019213/README.md#---book-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF-12) |
<br/>
...
Φτάσαμε στο παραδοτέο 12.. Μέσα απο όλες αυτές τις εργασίες(γραμμής εντολών,προγραμματισμού) κατάφερα ίσως με πιό μεγάλη επιτυχία(για μένα) να μπορέσω να χρησιμοποιήσω το github ως ενα προγραμματιστικό εργαλείο και όχι μόνο.<br>
