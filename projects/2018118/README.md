...
Για το 4ο παραδοτέο ασχολήθηκα με την λήψη αρχείου mp3, μέσω του εργαλείου "youtube-dl". Η  διαδικασία είναι πολύ ιδιαίτερη και είχε πολύ ενδιαφέρον λόγω της διάδρασης μεταξύ του cmd αντί γραφικού περιβάλλοντος. Χρησιμοποίησα επίσης μερικά options για την δημιουργία του mp3 καθώς και για την καλύτερη κατανόηση του αρχείου.
