...
| 3 | <sup><a href="#3"> Άσκηση γραμμής εντολών: warmup: get familiar with basic commands, reading documentation and editing files & hci: add a status bar to your shell/editor and configure a color-theme </a></sup> |
