...
### Πίνακας με σύνοψη των παραδοτέων και σύντομη αυταξιολόγηση εβδομάδας
...
| 3 | [Άσκηση γραμμής εντολών - 3ο παραδοτέο - fetch information](#άσκηση-γραμμής-εντολών---3ο-παραδοτέο---fetch-information) | Με την άσκηση αυτή ξεκίνησα να έχω επαφή με λειτουργίες όπου μπορούν να μας προσφέρουν πληροφορίες απο την γραμμή εντολών, ενώ δημιούργησα το 2ο shell script ενημέρωσης νέων. |
...
| 5 | [Άσκηση γραμμής εντολών - 5ο παραδοτέο - check the weather](#άσκηση-γραμμής-εντολών---5ο-παραδοτέο---check-the-weather) | Η άσκηση αυτή μου άρεσε ιδιαίτερα διότι θεωρώ χρήσιμο την ενημέρωση του καιρού,πόσο μάλλον απο την γραμμή εντολών όπου παρόμοια λειτουργία δεν είχα συναντήσει. Πιστεύω πως κάλυψα την άσκηση, ενώ έφτιαξα το 3ο shell script ενημέρωσης καιρού. |
...
- https://github.com/courses-ionio/hci/discussions/1705
