...
Μαζί με την εγκατάσταση της διανομής `Arch Linux` ζητήθηκε και η εκτέλεση των παρακάτω εντολών: `neofetch` και `journalctl -b` για να επιδείξουμε τα βασικά στοιχεία του υπολογιστή μας. Συγκεκριμένα, κατά την εγκατάσταση:
  ...
  ii) Στην συνέχεια, μόλις το USB έγινε bootable με την διαμόρφωση των μερών σε 3 κομμάτια (πρώτο (1) Linux Filesystem, δεύτερο (2) Boot Files και τρίτο     (3) Shared Files) ξεκίνησε η εγκατάσταση ορισμένων πακέτων τα οποία είναι υποχρεωτικά για την εύρυθμη λειτουργία του συστήματος. Μερικά από αυτά είναι:      για γραφικά (`xf86-video-intel` , `xf86-video-nouveau`, `xf86-video-ati`) για διαμόρφωση δίσκων: ( `gparted`), για σύνδεση στο δίκτυο(`NetworkManager`),    για γραφικό περιβάλλον ( `xfce4-session, xfce4-goodies` ) κα. Επιπλέον, εγκαταστάθηκαν και οι `file managers` όπως και οι εντολές `neofetch, journalctl`    για την καλτερη διεπαφη ανθρώπου - υπολογιστή.
