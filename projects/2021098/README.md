...
Μαζί με την εγκατάσταση της διανομής `Arch Linux` ζητήθηκε και η εκτέλεση των παρακάτω εντολών: `neofetch` και `journalctl -b` για να επιδείξουμε τα βασικά στοιχεία του υπολογιστή μας. Συγκεκριμένα, κατά την εγκατάσταση:
 ...
 iii) Δημιουργήθηκε και ο χρήστης βασικό όνομα `Spyros` και hostname τον προσωπικό μου αριθμό μητρώου (χωρίς τα πρώτα γράμματα, μόνο οι αριθμοί) όπως:       spyros@2021098, το ίδιο ισχύει και για τον χρήστη root: root@2021098 με την εντολή(sudo hostname 2021098). Μετά την δημιουργία των χρηστών, ο χρήστης       spyros δεν είχε δικαιώματα sudoer οπότε έπρεπε να προστεθεί στο αρχείο sudoers.
