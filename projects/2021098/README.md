...
Στο συγκεκριμένο παραδοτέο, έπρεπε να δημιουργήσουμε μια νέα μελέτη περίπτωσης και μια συγκεκριμένη βιογραφία, σχετικές με τα παραδοτέα [Α1](https://github.com/courses-ionio/help/discussions/1185) και [Α2](https://github.com/courses-ionio/help/discussions/1461) και να τα ανεβάσουμε στην [ιστοσελίδα](https://greekforce1821-site.netlify.app/) μας. Προκειμένου να συνδέσω την βιογραφία με τα προηγούμενα, επέλεξα να ασχοληθώ με τον δημιουργό της υψηλού επιπέδου γλώσσας προγραμματισμού `[Python](https://www.python.org/)`
