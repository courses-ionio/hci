...
Στο συγκεκριμένο παραδοτέο, καλούμαστε να συνεχίσουμε την: `Κατασκευή του Βιβλίου #2` σύμφωνα πάντα με τις [οδηγίες](https://github.com/courses-ionio/hci/discussions/1840) του μαθήματος. Δηλαδή, να προσθέσουμε στα κεφάλαια την νέα μελέτη περίπτωσης και την νέα βιογραφία που δημιουργήσαμε στο [παραδοτέο 9](https://github.com/courses-ionio/help/discussions/1817)
