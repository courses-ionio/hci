...
i) Πραγματοποιηθήκε με επιτυχία η χειροκίνητη εγκατάσταση της διανομής (δηλαδή, χωρίς την εκτέλεση της εντολής σε εξωτερικό USB stick, μέσω ενός μηχανήματος vm το οποίο δεν είχε εικονικό σκληρό δίσκο, αλλά χρησιμοποιήθηκε μόνο για να τρέξει το iso των Arch όπως προτεί
