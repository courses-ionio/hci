...
Ξεκινώντας, όπως αναφέρεται στις οδηγίες αν κάποιος φοιτητής δεν εγκαταστήσει την διανομή σε USB ή εξωτερικό σκληρό και την χρησιμοποιήσει σε VM δεν θα "κερδίσει" ολόκληρο τον βαθμό στο συγκεκριμένο παραδοτέο
