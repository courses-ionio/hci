...
Μαζί με την εγκατάσταση της διανομής `Arch Linux` ζητήθηκε και η εκτέλεση των παρακάτω εντολών: `neofetch` και `journalctl -b` για να επιδείξουμε τα βασικά στοιχεία του υπολογιστή μας. Συγκεκριμένα, κατά την εγκατάσταση:
 ...
 Προβλήματα:
   ...
   ii) Κατά την διάρκεια της εγκατάστασης ο χρήστης δεν μπορεί να έχει πρόσβαση στο internet μέσω ασύρματου δικτύου και πρέπει αναγκαστικά να αξιοποιήσει το ethernet μέχρι να εγκαταστήσει ο ίδιος τα πακέτα NetworkManager, dialog και wifi-menu για να μπορέσει να συνδεθέι ασύρματα.
