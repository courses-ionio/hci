...
### Περιγραφή: Listing των format από το τραγούδι, Downloading το τραγούδι σε .mp3 format & Listing το αρχείο στο directory Downloads μέσω της εφαρμογής [`Youtube-DL`]

Για τις παραπάνω πληροφορίες αξιοποιήθηκαν και ακολουθήθηκαν τα παρακάτω βήματα προκειμένουν 
