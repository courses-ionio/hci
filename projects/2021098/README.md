...
Στο συγκεκριμένο παραδοτέο, καλούμαστε να συνεχίσουμε την: `Κατασκευή του Βιβλίου #2` σύμφωνα πάντα με τις [οδηγίες](https://github.com/courses-ionio/hci/discussions/1839) του μαθήματος
