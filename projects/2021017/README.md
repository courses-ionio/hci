...
# Arch linux <br>
Στην εγκατάσταση τον arch linux, αν και βατή μπορω να πω οτι αντιμετόπησα πρόβληματα, όπως για παράδειγμα ο ήχος δεν δούλευε. Λόγο τον ελειπων γνωσεων μου επρεπε να ψάξω στο διαδηκτιο για λύσεις.Η οποία εμπειρία με έκανε να χρησημιοποιησώ το terminal και να γνωρίσω την χρήση του.<br>

# Συμμετοχικό περιεχόμενο Α1 <br>
Στην αναζήτηση φωτογραφιών και επαρκούς περιεχομένου για την δημιουργια των αρχειών στο _gallery ,έψαξα και βρήκα για τον υπολογιστή Amstrad-pcw16 και για το λειτουργικο σύστημα Breadbox Ensemble. Η διαδικασία προσάρτησεις τους είχε τις δυσκολίες τις.<br>

# Warm up cli <br>
Χρησημοποιόντας το terminal κάθε μέρα η άσκηση warm up cli ήταν εύκολη και απλή , με έκανε να καταλάβω την πληθόρα εντολών που μπορει να υπάρχουν και εγώ να μην το ξέρω. <br> 
