...
## Τι έκανα: 
Αρχικά εγκατέστησα τον emacs στο τερματικό του ubuntu για να έχω όλα τα απαραίτητα αρχεία του emacs και να μπορεί να τρέξει,έφτιαξα μια λίστα με τις σημειώσεις(notes.txt) μου, στο τέλος αποθήκευσα το αρχείο με την εντολή (Ctrl+x  + Ctrl+s ) και βγαίνω από το emacs αρχείο με την εντολή (Ctrl+x + Ctrl+c).Μετά τις αλλαγές που έγιναν στο αρχείο notes.txt ξαναμπαίνω για να επιβεβαιώσω ότι οι αλλαγές που έκανα ολοκληρώθηκαν.
