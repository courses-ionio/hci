...
<p>Σε αυτή την την άσκηση, σκοπός είναι να γίνει αναζήτηση των μετεωρολογικών προγνωστικών για την τοποθεσία μου και για μια ακόμα χώρα ή περιοχή της επιλογής μου, μέσω του τερματικού του λειτουργικού συστήματος UBUNTU.
...
<p>Για αυτή την άσκηση πρέπει να περιηγηθώ στα αρχεία του υπολογιστή μου και να ανοίξω έναν φάκελο της επιλογής μου, με σκοπό να δω τα αρχεία του. Όλη η διαδικασία πρέπει να γίνει μέσω του τερματικού του λειτουργικού συστήματος UBUNTU.
...
<p>Για αυτή την άσκηση, χρειάστηκε η επεξεργασία του δοσμένου CSS κώδικα, ώστε να αλλάξει η απόσταση των στοιχείων μιας λίστας στοιχείων, το μέγεθος των γραμμάτων τους και το χρώμα τους.
...
<p>Μέσω αυτής της άσκησης, πρέπει να κατεβάσω τοπικά στον υπολογιστή μου ένα τραγούδι της επιλογής μου από το YouTube και να το ακούσω τοπικά, μέσω του τερματικού του λειτουργικού συστήματος UBUNTU.
