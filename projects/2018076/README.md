...
| 12 | Τελική αναφορά* | | Είμαι περήφανος με τον εαυτό για το σημείο που έφτασα μέχρι τώρα και τις ικανότητες που απέκτησα μέσω των δραστηριοτήτων στα πλαίσια του μαθήματος. |
