...
- [Taskwarrior to-do list για το τερματικό](https://asciinema.org/a/uzCwgZncOCfUSA59VcSRrn3Nb): Δημιουργία τριών εργασιών, προβολή της λίστας με τις εργασίες, ολοκλήρωση των δύο και διαγραφή της μίας.
