...
- [Προσπέλαση και επεξεργασία αρχείων με το Ranger](): Προσπέλαση των αρχείων του συστήματος με την χρήση του εργαλείου [Ranger](https://ranger.github.io/) και άνοιγμα ενός αρχείου για επεξεργασία.

- [Προσπέλαση και επεξεργασία αρχείων με το Vifm](): Όπως το [Ranger](https://ranger.github.io/) έτσι και το [Vifm](https://vifm.info/) είναι ένα terminal file manager το οποίο χρησιμοποιεί το [Vim](https://www.vim.org/) για την επεξεργασία αρχείων.
