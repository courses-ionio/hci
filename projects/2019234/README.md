...
### Σύνοψη
Όλα τα παραδοτέα έγιναν εντός προθεσμίας.Μετά από την διορία των παραδοτέων έγιναν αρκετές βελτιώσεις όσον αφορά την συνολική εικόνα της εργασίας.Αντιμετώπισα αρκετές δυσκολίες κυρίως στις ασκήσεις γραμμής εωτολών καθώς δεν είχα ξανά εργαστεί με Linux και χρειάστικε αρκετός χρόνος για την εκμάθηση του συγκεκριμένου του συστήματος.Πιο συγκεκριμένα περισσότερες δυσκολίες συνάτησα στην άσκσηση  download mp3.Προσπαθώντας να την κάνω  σε  Windows Linux Subsystem των windows 10 αντιμετώπισα πρόβλημα στο mpv όπου μου έβγαζε αρκετά error στην προσπάθεια να παίξει το τραγούδι,έτσι αποφάσισα να τη προσπαθήσω σε virtual box όπου και την ολοκλήρωσα με επιτυχία.Τέλος προβλήματα αντιμετώπισα και στο συμμετοχικό περιεχόμενο καθώς δεν μπόρεσα, χρησιμοποιώντας τα git submodules, να εμφανίσω τις πληροφορίες που βρήκα στο site μου.
...
### Συμπεράσματα
Οι στόχοι που είχα θέσει στην αρχή του εξαμήνου εχουν καλυφθεί.Σε αυτό το μάθημα έμαθα αρκετά ενδιαφέροντα πράγματα όπως  την ιστορία διεπαφών και υπολογιστών, πως να χρησιμοποιώ το  terminal σε λειτουργικό linux καθώς χρειάστικε να κάνω ασκήσεις πάνω σε αυτό , όπου αφιέρωσα και τον περισσότερο χρόνο σε σχέση με οτιδήποτε άλλο αφορούσε την εγρασία.Τέλος θα μπορούσα να πω ότι ήταν ενα ενδιαφέρον μάθημα καθώς έμαθα αρκετά πράγματα που ίσως χρησιμεύσουν και σε άλλα μαθήματα του πανεπιστημίου.
