...
### Assignment 1
  ...
  Προσθέτοντας μία ακόμα παράμετρο εμφάνισα όλα τα αρχεία στο directory με επιπλέον των δημιουργό, τα δικαιματα που υπάρχουν στα αρχεία, το group στο οποίο ανήκει κάθε αρχείο, το μέγεθος του αρχείου, τελευταία ημερομηνία τροποποίησης αλλά και το βάθος του κάθε directory σε υποφακέλους.
