...
Το πρώτο ζητούμενο ήταν να αλλάξω μία από τις δύο φωτογραφίες. Επέλεξα να αλλάξω και τις δύο. Πρώτα άλλαξα τον HTML κώδικα και συγκεκριμένα το src στο <img> function όπου έβαλα το URL της φωτογραφίας που επέλεξα να φαίνεται μετά την διαγραφή. Παράλληλα άλλαξα το width και το height για να ταιριάζει με την φωτογραφία που βρήκα. Τέλος άλλαξα στο width και το height στον καμβά όπου έβαλα τις ίδιες διαστάσεις με την φωτογραφία.
