...
Αρχικά οταν κατέβασα τα πολύ βασικά του arch είχα κατεβάσει το GNOME, για να έχω ενα desktop enviroment. Όμως μέτα έμαθα για τα window manager και κατέβασα το i3 με όλο το πακέτο, υστέρα αφου φτιάχνοντας της ρυθμίσεις στο config του i3 είχα αυτό το αποτέλεσμα :
