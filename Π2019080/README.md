# Εργασία εξαμήνου στο μάθημα Επικοινωνία Ανθρώπου Υπολογιστή
...
# Παραδοτέο 4ο
## Άσκηση προγραμματισμού Διαδραστικού παραδείγματος πολύπλοκου κυκλικού μενού (Menu Pie) 
...
### Ζητούμενα της άσκησης: fetch the weather forecast for your home city and one more city that you want to travel to
...
**Αποτέλεσμα ειδοποίησης στην οθόνη:**
...
### Ζητούμενα της άσκησης: search, download and play (with the terminal) your favorite song of the month from youtube

### Χρησιμοποιήθηκαν οι εντολές:
* **Youtube-dl -F**
* **youtube-dl -f**
* **Καθώς και έγινε χρήση Copy/Paste του συνδέσμου του τραγουδιού**

**_Απο κάτω με την χρήση του προγράμματος κατέβηκε το τραγούδι "505" απο τους Arctic Monkeys._**
