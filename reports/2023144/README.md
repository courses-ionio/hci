...
Πάντως, η γνώση και οι δεξιότητες που απέκτησα από το μάθημα θα με βοηθήσουν (με έχουν ήδη βοηθήσει) σε τεράστιο βαθμό για να πετύχω τους στόχους μου. Ως προς την απόδοσή μου, υπάρχει περιθώριο για βελτίωση. Εγώ πάντως είμαι ευχαριστημένος με το αποτέλεσμα που απέδωσα.
