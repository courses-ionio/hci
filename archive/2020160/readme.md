...
Παρακολουθούσα και παρακολουθώ τις συζητήσεις (ερωτοαπαντήσεις) που λαμβάνουν χώρα online σχετικά με το μάθημα, απλώς είτε δεν είχα να προσφέρω κάτι νέο σαν πληροφορία είτε είχε δωθεί απάντηση. Παρ' όλα αυτά, κατάφερα και πρότεινα σε κάποιους συμφοιτητές μου αλλαγές στην μορφή του τελικού παραδοτέου.
- https://github.com/courses-ionio/hci/pull/1691
- https://github.com/courses-ionio/hci/pull/1680/

# Τελική αναφορά

## last report

Πιστεύω πως εκπληρώθηκαν οι προσωπικοί στόχοι που είχα θέσει για το μάθημα. Έμαθα την χρησιμότητα του τερματικού, δούλεψα συνεργατικά και ασύγχρονα με άλλους συμφοιτητές μου και είδα πως είναι να συνεισφέρει κάποιος σε ένα μεγάλο και ολοκληρωμένο project. 
