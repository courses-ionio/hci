...
### Δυσκολίες που αντιμετοπίστηκαν:

1) Υπηρξε πρόβλημα με την σύνδεση μου στο διαδίκτυο.

2) Υπηρξε πρόβλημα με την δέσμευση μνήμης από το λειτουργικό σύστημα των Windows που όταν έφτασα στην εγκατάσταση και την δημιουργία του FileSystem και του Linux Swap δυσκολεύτηκα αρκέτα αλλά με την βοήθεια της ομάδας μου, διαφόρων βίντεο και διαφόρων forum έφτασα στην λύση του προβλήματος που αντιμετπησα.
